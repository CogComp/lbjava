...
\begin{figure}[t]
\begin{code}
1. \>{\color{Purple} import} LBJ2.parse.LineByLine; \\
2. \>\\
...
\begin{figure}[t]
\begin{code}
1. \>{\color{Purple} import} LBJ2.nlp.seg.Token;\\
2. \>\\
...
extending \path{LBJ2.learn.Learner} accessible on the \path{CLASSPATH}) and
...
From these elements, the LBJ compiler generates Java source code that performs
