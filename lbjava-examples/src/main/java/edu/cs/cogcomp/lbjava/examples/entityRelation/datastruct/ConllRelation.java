...
public class ConllRelation {
    ...
    public String toString() {
        return "ConllRelation{" + "wordId1=" + wordId1 + ", wordId2=" + wordId2 + ", sentId="
                + sentId +
                // ", s=" + s + // D: this throws exception and I couldn't figure out why. I am
                // commenting it out.
                ", relType='" + relType + '\'' + ", e1=" + e1 + ", e2=" + e2 + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        if (sentId != that.sentId)
            return false;
        if (wordId1 != that.wordId1)
            return false;
        if (wordId2 != that.wordId2)
            return false;
        if (e1 != null ? !e1.equals(that.e1) : that.e1 != null)
            return false;
        if (e2 != null ? !e2.equals(that.e2) : that.e2 != null)
            return false;
        if (relType != null ? !relType.equals(that.relType) : that.relType != null)
            return false;
