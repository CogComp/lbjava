...
public class ContainsStation extends DumbLearner {
    public ContainsStation() {
        super("edu.cs.cogcomp.lbjava.examples.setCover.ContainsStation");
    }

    public String getInputType() {
        return "edu.cs.cogcomp.lbjava.examples.setCover.Neighborhood";
    }
