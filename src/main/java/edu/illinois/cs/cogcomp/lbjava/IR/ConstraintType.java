...
public class ConstraintType extends ClassifierType
{
  ...
  public ConstraintType(Type i) {
    ...
    try { myClass = Class.forName("edu.illinois.cs.cogcomp.lbjava.infer.ParameterizedConstraint"); }
    catch (Exception e) {
      System.err.println("Class 'edu.illinois.cs.cogcomp.lbjava.infer.ParameterizedConstraint' not "
                         + "found.  Aborting.");
      System.exit(1);
    }
  }
