...
public class ClassifierType extends Type
{
  ...
  public ClassifierType(Type i, ClassifierReturnType o, boolean l) {
    ...
    try { myClass = Class.forName("edu.illinois.cs.cogcomp.lbjava.classify.Classifier"); }
    catch (Exception e) {
      System.err.println("Class 'edu.illinois.cs.cogcomp.lbjava.classify.Classifier' not found.  "
                         + "Aborting.");
      System.exit(1);
    }
  }
