...
public class NormalizerType extends Type
{
  ...
  public NormalizerType() {
    ...
    try { myClass = Class.forName("edu.illinois.cs.cogcomp.lbjava.learn.Normalizer"); }
    catch (Exception e) {
      System.err.println("Class 'edu.illinois.cs.cogcomp.lbjava.learn.Normalizer' not found.  "
                         + "Aborting.");
      System.exit(1);
    }
  }
