...
public class InferenceType extends Type
{
  ...
  public InferenceType(Type h, Type[] f) {
    ...
    try { myClass = Class.forName("edu.illinois.cs.cogcomp.lbjava.infer.Inference"); }
    catch (Exception e) {
      System.err.println("Class 'edu.illinois.cs.cogcomp.lbjava.infer.Inference' not found.  "
                         + "Aborting.");
      System.exit(1);
    }
  }
