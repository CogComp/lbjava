...
The most important class in ’s library is `LBJ2.classify.Classifier`. This abstract class
...
`LBJ2.classify.LabelVectorReturner` are used internally by the  compiler to help implement
