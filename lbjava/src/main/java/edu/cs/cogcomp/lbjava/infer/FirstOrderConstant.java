...
public class FirstOrderConstant extends FirstOrderConstraint {
    ...
    /**
     * The hash code of a <code>FirstOrderConstant</code> is the hash code of the
    ...
    /**
     * Two <code>FirstOrderConstant</code>s are equivalent when their constants are equal.
     *
     * @return <code>true</code> iff the argument is a <code>FirstOrderConstant</code> set to the
     *         same value as this constant.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderConstant))
            return false;
