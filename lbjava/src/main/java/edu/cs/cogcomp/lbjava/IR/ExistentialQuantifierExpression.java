...
public class ExistentialQuantifierExpression extends QuantifiedConstraintExpression {
     ...
     **/
    public ExistentialQuantifierExpression(int line, int byteOffset, Argument a, Expression c,
     ...
     * @param co The quantified constraint.
     **/
    public ExistentialQuantifierExpression(TokenValue t, Argument a, Expression c,
                                           ConstraintExpression co) {
     ...
     **/
    public Object clone() {
        return new ExistentialQuantifierExpression(-1, -1, (Argument) argument.clone(),
