 ...
 * the classifier. This behavior differs from that of {@link ValueComparer} because it does not
 * assume that the given classifier will return only a single feature.
 *
 * @author Nick Rizzolo
 **/
public class MultiValueComparer extends ValueComparer {
     ...
     * {@link ValueComparer#labeler} applied to the argument object contained the feature value
     * referenced by {@link ValueComparer#value}.
     *
    ...
    public Feature featureValue(Object o) {
        ...
        return new DiscretePrimitiveStringFeature("", "MultiValueComparer", "",
                DiscreteFeature.BooleanValues[p], p, (short) 2);
    }
    ...
    /**
     * The <code>String</code> representation of a <code>ValueComparer</code> has the form
     * <code>"ValueComparer(</code><i>child</i><code>)</code>, where <i>child</i> is the
     * <code>String</code> representation of the classifier whose value is being compared.
     *
