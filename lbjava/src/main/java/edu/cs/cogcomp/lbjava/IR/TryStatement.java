...
public class TryStatement extends Statement {
     ...
     **/
    public Object clone() {
        return new TryStatement((Block) block.clone(), (CatchList) catchList.clone(),
    ...
    public int hashCode() {
        ...
        if (finallyBlock != null)
            result += 7 * finallyBlock.hashCode();
        return result;
    }
    ...
    public boolean equals(Object o) {
        ...
        return block.equals(t.block)
                && catchList.equals(t.catchList)
                && (finallyBlock == null ? t.finallyBlock == null : finallyBlock
                        .equals(t.finallyBlock));
    }
