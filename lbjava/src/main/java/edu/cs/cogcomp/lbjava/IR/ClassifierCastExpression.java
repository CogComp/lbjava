...
public class ClassifierCastExpression extends ClassifierExpression {
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the type.
     *
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ClassifierCastExpression))
            return false;
     ...
     **/
    public Object clone() {
        return new ClassifierCastExpression((ClassifierReturnType) castType.clone(),
