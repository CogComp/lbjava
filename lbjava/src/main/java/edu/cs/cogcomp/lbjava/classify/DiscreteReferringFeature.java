...
public class DiscreteReferringFeature extends DiscreteReferrer {
     ...
     **/
    public DiscreteReferringFeature(Classifier c, ByteString i, DiscreteFeature r, String[] av) {
        super(c, r, av);
        identifier = i;
    }
     ...
     **/
    public DiscreteReferringFeature(String p, String c, ByteString i, DiscreteFeature r, short vi,
            short t) {
        super(p, c, r, vi, t);
        identifier = i;
    }
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        ...
        if (training)
            ...
            return this;
        return new DiscreteReferringFeature(containingPackage, generatingClassifier, identifier, f,
    ...
    public RealFeature makeReal() {
        return new RealReferringFeature(containingPackage, generatingClassifier, identifier,
                referent.makeReal());
    }
    ...
    public Feature encode(String e) {
        ...
        if (newReferent == referent)
            return this;
        return new DiscreteReferringFeature(containingPackage, generatingClassifier, identifier,
                newReferent, valueIndex, totalValues);
    }


    /**
     * The hash code of a <code>DiscreteReferringFeature</code> is the sum of the hash codes of its
    ...
    /**
     * Two <code>DiscreteReferringFeature</code>s are equivalent when their containing packages,
