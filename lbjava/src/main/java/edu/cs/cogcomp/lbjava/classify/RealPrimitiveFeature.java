...
public class RealPrimitiveFeature extends RealFeature {
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        return new RealPrimitiveFeature(containingPackage, generatingClassifier, identifier, 0);
    }
    ...
    public RealFeature multiply(double m) {
        return new RealPrimitiveFeature(containingPackage, generatingClassifier, identifier, value
                * m);
    }
    ...
    public Feature withStrength(double s) {
        return new RealPrimitiveFeature(containingPackage, generatingClassifier, identifier, s);
    }
    ...
    /**
     * The hash code of a <code>RealPrimitiveFeature</code> is the sum of the hash codes of the
     * containing package, the identifier, and the value.
     *
     * @return The hash code for this feature.
     **/
    public int hashCode() {
        return 31 * super.hashCode() + 17 * identifier.hashCode() + new Double(value).hashCode();
    }


    /**
     * Two <code>RealPrimitiveFeature</code>s are equivalent when their containing packages and
