...
public class MethodInvocation extends StatementExpression {
    /**
     * (&oslash;) This expression evaluates to the object whose method will be called.
     **/
    ...
    /**
     * Filled in by the <code>SemanticAnalysis</code> pass, this variable is set to
     * <code>true</code> iff this invocation represents a classifier invocation.
     *
    ...
    /**
     * Filled in by the <code>SemanticAnalysis</code> pass, this variable is set to
     * <code>true</code> iff this invocation is the argument of a learning classifier expression's
     * evaluate clause.
     *
     * @see SemanticAnalysis
     **/
    ...
    /**
     * The <code>SemanticAnalysis</code> pass will let this <code>MethodInvocation</code> know if it
     * is the immediate <code>value</code> child of a <code>SenseStatement</code> by setting this
     * flag.
     *
     * @see SemanticAnalysis
     **/
    ...
    /**
     * Initializing constructor. Line and byte offset information is taken from the representation
     * of the name.
     *
     * @param n The name of the method being invoked.
     **/
    public MethodInvocation(Name n) {
        this(n, new ExpressionList());
    }
    ...
    /**
     * Parser's constructor. Line and byte offset information is taken from the representation of
     * the name.
     *
     ...
     **/
    public MethodInvocation(Expression p, Name n, ExpressionList a, int line, int byteOffset) {
    ...
    public HashSet getVariableTypes() {
        ...
        if (parentObject != null)
            result.addAll(parentObject.getVariableTypes());
    ...
    public boolean containsQuantifiedVariable() {
        return parentObject != null && parentObject.containsQuantifiedVariable()
                || name.containsQuantifiedVariable(true) || arguments.containsQuantifiedVariable();
    }
    ...
    public int hashCode() {
        ...
        if (parentObject != null)
            result += 7 * parentObject.hashCode();
        return result;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (parentObject == null ? i.parentObject == null : parentObject.equals(i.parentObject))
     ...
     **/
    public Object clone() {
        return new MethodInvocation((parentObject == null) ? null
                : (Expression) parentObject.clone(), (Name) name.clone(),
                (ExpressionList) arguments.clone(), -1, -1);
    }
