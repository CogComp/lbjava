...
public class ClassifierExpressionList extends List {
     ...
     *
     * @param e A reference to the <code>ClassifierExpression</code> to be added.
     **/
    public void add(ClassifierExpression e) {
        list.add(e);
    }
     ...
     **/
    public void addAll(ClassifierExpressionList e) {
        list.addAll(e.list);
    }
    ...
    public ClassifierExpression[] toArray() {
        return (ClassifierExpression[]) list.toArray(new ClassifierExpression[list.size()]);
    }
