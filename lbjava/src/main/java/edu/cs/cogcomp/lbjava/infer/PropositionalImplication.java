...
public class PropositionalImplication extends PropositionalBinaryConstraint {
     ...
     **/
    public PropositionalImplication(PropositionalConstraint l, PropositionalConstraint r) {
        super(l, r);
    }
    ...
    public PropositionalConstraint CNF() {
        return new PropositionalDisjunction(new PropositionalNegation(left), right).CNF();
    }
    ...
    public PropositionalConstraint DNF() {
        return new PropositionalDisjunction(new PropositionalNegation(left), right).DNF();
    }
    ...
    public boolean moreSpecificThan(PropositionalDisjunction c) {
        return c.contains(new PropositionalNegation(left)) && c.contains(right) || c.contains(this);
    }
    ...
    /**
     * The hash code of a <code>PropositionalImplication</code> is the sum of the hash codes of its
     * children plus two.
     *
    ...
    /**
     * Two <code>PropositionalImplication</code>s are equivalent when they are topologically
     * equivalent.
     *
    ...
    public boolean equals(Object o) {
        if (!(o instanceof PropositionalImplication))
            return false;
