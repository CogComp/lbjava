...
import edu.cs.cogcomp.lbjava.TranslateToJava;
import edu.cs.cogcomp.lbjava.classify.Classifier;


/**
 * This class represents identifiers that name classifiers. It is ostensibly the same class as
 * <code>Name</code>, but it extends <code>ClassifierExpression</code>, helping keep the syntax of
 * classifier manipulation separate from Java's method definition syntax.
 *
 * @see Name
 * @author Nick Rizzolo
 **/
public class ClassifierName extends ClassifierExpression {
    /**
     * (&not;&oslash;) The name as it appears in the source code. The member variable
     * <code>name</code> defined in <code>ClassifierExpression</code> will be used by
     * <code>SemanticAnalysis</code> for other purposes.
     *
    ...
    /**
     * Is used to distinguish {@link Classifier}s that are defined as fields. Used during
     * {@link TranslateToJava}.
     */
    public boolean isField;

    /**
     * Full constructor. Line and byte offset information is taken from the name.
     *
     * @param n A name.
     **/
     ...
     **/
    public ClassifierName(String n) {
        this(n, -1, -1);
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ClassifierName))
            return false;
     ...
     * <code>ClassifierExpression</code>.
     *
