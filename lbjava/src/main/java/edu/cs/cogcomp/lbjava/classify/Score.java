 ...
 * discrete classification is appropriate for a given object. The scores for all possible discrete
 * classifications given an object need not be positive or sum to one. A <code>Score</code> object
...
public class Score implements Comparable, Cloneable {
    ...
    /**
     * This method is implemented so that a collection of <code>Score</code>s will be sorted first
     * by value and then by score.
     *
     * @param o The object to compare against.
     * @return A negative integer, zero, or a positive integer if this object is less than, equal
     *         to, or greater than the specified object respectively.
     **/
    ...
    /**
     * The string representation of a <code>Score</code> is the value followed by the score
