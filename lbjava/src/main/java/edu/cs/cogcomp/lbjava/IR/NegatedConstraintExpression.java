...
public class NegatedConstraintExpression extends ConstraintExpression {
     ...
     **/
    public NegatedConstraintExpression(int line, int byteOffset, ConstraintExpression c) {
     ...
     **/
    public Object clone() {
        return new NegatedConstraintExpression(-1, -1, (ConstraintExpression) constraint.clone());
    }
