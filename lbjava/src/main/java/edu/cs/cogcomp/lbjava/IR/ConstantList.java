...
public class ConstantList extends List {
     ...
     *
     * @param c A single <code>Constant</code> with which to initialize this list.
     **/
    ...
    /**
     * Adds all the <code>Constant</code>s in another <code>ConstantList</code> to the end of this
     * <code>ConstantList</code>.
     *
     * @param l The list to be added.
     **/
    public void addAll(ConstantList l) {
        list.addAll(l.list);
    }
     ...
     *
     * @return An array of constants containing references to every constant in the list.
     **/
    ...
    /**
     * Two <code>ConstantList</code>s are equal when they contain the same elements in the same
     * order as evaluated by the <code>Constant.equals(Object)</code> method.
     *
     * @param o The object to test equality with.
     * @return <code>true</code> iff this <code>ConstantList</code> is equivalent to the specified
