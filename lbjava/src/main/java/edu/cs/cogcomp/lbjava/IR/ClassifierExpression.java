...
/**
 * Abstract classifier expression class. The member variables of this class are filled in either
 * during parsing or during semantic analysis, but in any case, they do not represent AST children
...
public abstract class ClassifierExpression extends ASTNode implements CodeGenerator {
    /**
     * (&oslash;) The text of a Javadoc comment that may be associated with this classifier.
     **/
     ...
     **/
    ClassifierExpression(int line, int byteOffset) {
     ...
     *
     * @param c The new expression for the <code>cacheIn</code> member variable.
     **/
