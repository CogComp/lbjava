 ...
 * value to a given value. The argument classifier must be <code>discrete</code>.
 *
...
public class ValueComparer extends Classifier {
     ...
     * output of {@link #labeler} applied to the argument object and {@link #value}.
     *
    ...
    public Feature featureValue(Object o) {
        ...
        return new DiscretePrimitiveStringFeature("edu.cs.cogcomp.lbjava.classify",
                "ValueComparer", "", DiscreteFeature.BooleanValues[prediction], prediction,
                (short) 2);
    }
