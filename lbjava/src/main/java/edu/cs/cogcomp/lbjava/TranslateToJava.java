...
import edu.cs.cogcomp.lbjava.infer.Constraint;
import edu.cs.cogcomp.lbjava.io.HexOutputStream;
import edu.cs.cogcomp.lbjava.learn.Learner;
import edu.cs.cogcomp.lbjava.IR.AST;
import edu.cs.cogcomp.lbjava.IR.ASTNode;
import edu.cs.cogcomp.lbjava.IR.ASTNodeIterator;
import edu.cs.cogcomp.lbjava.IR.Argument;
import edu.cs.cogcomp.lbjava.IR.ArrayCreationExpression;
import edu.cs.cogcomp.lbjava.IR.ArrayInitializer;
import edu.cs.cogcomp.lbjava.IR.ArrayType;
import edu.cs.cogcomp.lbjava.IR.AssertStatement;
import edu.cs.cogcomp.lbjava.IR.Assignment;
import edu.cs.cogcomp.lbjava.IR.AtLeastQuantifierExpression;
import edu.cs.cogcomp.lbjava.IR.AtMostQuantifierExpression;
import edu.cs.cogcomp.lbjava.IR.BinaryConstraintExpression;
import edu.cs.cogcomp.lbjava.IR.BinaryExpression;
import edu.cs.cogcomp.lbjava.IR.Block;
import edu.cs.cogcomp.lbjava.IR.BreakStatement;
import edu.cs.cogcomp.lbjava.IR.CastExpression;
import edu.cs.cogcomp.lbjava.IR.CatchClause;
import edu.cs.cogcomp.lbjava.IR.CatchList;
import edu.cs.cogcomp.lbjava.IR.ClassifierAssignment;
import edu.cs.cogcomp.lbjava.IR.ClassifierExpression;
import edu.cs.cogcomp.lbjava.IR.ClassifierExpressionList;
import edu.cs.cogcomp.lbjava.IR.ClassifierName;
import edu.cs.cogcomp.lbjava.IR.ClassifierReturnType;
import edu.cs.cogcomp.lbjava.IR.ClassifierType;
import edu.cs.cogcomp.lbjava.IR.CodedClassifier;
import edu.cs.cogcomp.lbjava.IR.CompositeGenerator;
import edu.cs.cogcomp.lbjava.IR.Conditional;
import edu.cs.cogcomp.lbjava.IR.Conjunction;
import edu.cs.cogcomp.lbjava.IR.Constant;
import edu.cs.cogcomp.lbjava.IR.ConstantList;
import edu.cs.cogcomp.lbjava.IR.ConstraintDeclaration;
import edu.cs.cogcomp.lbjava.IR.ConstraintEqualityExpression;
import edu.cs.cogcomp.lbjava.IR.ConstraintInvocation;
import edu.cs.cogcomp.lbjava.IR.ConstraintStatementExpression;
import edu.cs.cogcomp.lbjava.IR.ContinueStatement;
import edu.cs.cogcomp.lbjava.IR.DoStatement;
import edu.cs.cogcomp.lbjava.IR.ExistentialQuantifierExpression;
import edu.cs.cogcomp.lbjava.IR.Expression;
import edu.cs.cogcomp.lbjava.IR.ExpressionList;
import edu.cs.cogcomp.lbjava.IR.ExpressionStatement;
import edu.cs.cogcomp.lbjava.IR.FieldAccess;
import edu.cs.cogcomp.lbjava.IR.ForStatement;
import edu.cs.cogcomp.lbjava.IR.IfStatement;
import edu.cs.cogcomp.lbjava.IR.IncrementExpression;
import edu.cs.cogcomp.lbjava.IR.InferenceDeclaration;
import edu.cs.cogcomp.lbjava.IR.InferenceInvocation;
import edu.cs.cogcomp.lbjava.IR.InferenceType;
import edu.cs.cogcomp.lbjava.IR.InstanceCreationExpression;
import edu.cs.cogcomp.lbjava.IR.InstanceofExpression;
import edu.cs.cogcomp.lbjava.IR.LabeledStatement;
import edu.cs.cogcomp.lbjava.IR.LearningClassifierExpression;
import edu.cs.cogcomp.lbjava.IR.MethodInvocation;
import edu.cs.cogcomp.lbjava.IR.Name;
import edu.cs.cogcomp.lbjava.IR.NegatedConstraintExpression;
import edu.cs.cogcomp.lbjava.IR.Operator;
import edu.cs.cogcomp.lbjava.IR.ParameterSet;
import edu.cs.cogcomp.lbjava.IR.PrimitiveType;
import edu.cs.cogcomp.lbjava.IR.QuantifiedConstraintExpression;
import edu.cs.cogcomp.lbjava.IR.ReferenceType;
import edu.cs.cogcomp.lbjava.IR.ReturnStatement;
import edu.cs.cogcomp.lbjava.IR.SenseStatement;
import edu.cs.cogcomp.lbjava.IR.StatementList;
import edu.cs.cogcomp.lbjava.IR.SubscriptVariable;
import edu.cs.cogcomp.lbjava.IR.SwitchGroup;
import edu.cs.cogcomp.lbjava.IR.SwitchGroupList;
import edu.cs.cogcomp.lbjava.IR.SwitchLabel;
import edu.cs.cogcomp.lbjava.IR.SwitchLabelList;
import edu.cs.cogcomp.lbjava.IR.SwitchStatement;
import edu.cs.cogcomp.lbjava.IR.SynchronizedStatement;
import edu.cs.cogcomp.lbjava.IR.ThrowStatement;
import edu.cs.cogcomp.lbjava.IR.TryStatement;
import edu.cs.cogcomp.lbjava.IR.Type;
import edu.cs.cogcomp.lbjava.IR.UnaryExpression;
import edu.cs.cogcomp.lbjava.IR.UniversalQuantifierExpression;
import edu.cs.cogcomp.lbjava.IR.VariableDeclaration;
import edu.cs.cogcomp.lbjava.IR.WhileStatement;
import edu.cs.cogcomp.lbjava.classify.Classifier;
import edu.cs.cogcomp.lbjava.infer.EqualityArgumentReplacer;
import edu.cs.cogcomp.lbjava.infer.FirstOrderEquality;
...
public class TranslateToJava extends Pass {
    ...
    public static final String disclaimer =
            "// Modifying this comment will cause the next execution of LBJava to "
                    + "overwrite this file.";
    /**
     * This array contains string descriptions of methods that don't need to be overridden when
     * generating code for a learner.
     **/
    private static final String[] noOverride =
            {
                    ...
                    "public edu.cs.cogcomp.lbjava.classify.Feature featureValue(java.lang.Object a0)",
                    "public edu.cs.cogcomp.lbjava.classify.FeatureVector classify(java.lang.Object a0)",
                    "public edu.cs.cogcomp.lbjava.classify.FeatureVector[] classify(java.lang.Object[] a0)",
                    ...
                    "public void learn(java.lang.Object[] a0)", "public void unclone()"};
    /**
     * The prefix of the name of the temporary variable in which a constraint's computed value
     * should be stored. This variable is only used when {@link #constraintMode} is unset.
     **/
    ...
    /**
     * Lets {@link VariableDeclaration}s know if they are contained in the initialization portion of
     * the header of a <code>for</code> loop.
     **/
    private boolean forInit;
    /**
     * Filenames that have been generated during the processing of one statement.
     **/
    private HashSet<String> files;
    /**
     * When this flag is set, code generated for constraint expressions will create
     * {@link Constraint} objects rather than computing the
     * value of the constraint expression.
     **/
    private boolean constraintMode;
    /**
     * This variable is appended to the {@link #constraintResult} variable to form the name of a new
     * temporary variable.
     **/
    ...
    /**
     * Lets AST children know the index that a given quantification variable occupies in an
     * {@link EqualityArgumentReplacer}'s vector; the keys of the map are names of quantification
     * variables, and the values are <code>Integer</code>s.
     **/
    private HashMap<String, Integer> quantificationVariables;
    /**
     * Lets AST children know the index that a given context variable occupies in an
     * {@link EqualityArgumentReplacer}'s vector; the keys of the map are names of context
     * variables, and the values are <code>Integer</code>s.
     **/
    ...
    /**
     * Uses the current value of {@link #indent} to append the appropriate number of spaces to
     * {@link #methodBody}.
     **/
    ...
    /**
     * Uses the current value of {@link #indent} to append the appropriate number of spaces to
     * {@link #methodBody}, followed by the argument string.
     *
    ...
    /**
     * Appends the current indent via {@link #appendIndent()}, then appends the argument string and
     * a newline.
     *
     ...
     **/
    public void setCurrentCG(CodeGenerator cg) {
        currentCG = cg;
    }
    ...
    /**
     * Gives access to the {@link #methodBody} member variable so that this pass can be invoked
    ...
    /**
     * Create a <code>PrintStream</code> that writes to a Java file corresponding to the specified
     * {@link CodeGenerator}.
     *
     ...
     * {@link Learner} to check types and call themselves on
     ...
     * {@link Learner} down to the super class of this learner
     * are overridden to call the super class's implementation on the unique instance.
     *
     * @param out The stream to write to.
     * @param lce The {@link LearningClassifierExpression} representing the learner.
     **/
    @SuppressWarnings("rawtypes")
    public static void generateLearnerBody(PrintStream out, LearningClassifierExpression lce) {
        ...
        if (invoked != null && invoked.size() > 0) {
            for (Iterator I = invoked.iterator(); I.hasNext();) {
                ...
                out.println("  private static final " + name + " __" + nameNoDots + " = new "
                        + name + "();");
            }
        ...
        if (lce.parameterSets.size() == 0) {
            ...
            out.println(");");
            out.println("    containingPackage = \"" + AST.globalSymbolTable.getPackage() + "\";");
            ...
            if (isField(lce.extractor)) {
                String fieldClass =
                        AST.globalSymbolTable.classForName(lce.extractor.name).getSimpleName();
        ...
        if (lce.singleExampleCache) {
            out.println("  private static ThreadLocal __cache = new ThreadLocal(){ };");
            out.println("  private static ThreadLocal __exampleCache = " + "new ThreadLocal(){ };");
            out.println("  public static void clearCache() { __exampleCache = new "
                    + "ThreadLocal() { }; }");
        }

        if (lce.attributeString.length() != 0 && lce.learnerParameterBlock == null)
            out.println("  private static final String attributeString = \"" + lce.attributeString
                    + "\";");
       ...
       out.println(tabs + "readModel(IOUtilities.loadFromClasspath(" + lceName
        ...
        out.println("    {");
        out.print(generateTypeChecking("      ", lceName, "Classifier", false, inputString,
                lce.line, "example", true));
        out.println("      loadInstance();");
        ...
        out.println("    if (isClone)");
        out.println("    {");
        out.print(generateTypeChecking("      ", lceName, "Classifier", true, inputString,
                lce.line, "examples", true));
        out.println("      loadInstance();");
        ...
        preamble.append(generateTypeChecking("      ", lceName, "Classifier", false, inputString,
                lce.line, "__example", true));
        ...
        if (lce.checkDiscreteValues) {
            ...
            if (!primitive) {
                post.append("    for (int __i = 0; __i < __result.featuresSize(); ++__i)\n"
        ...
        generateClassificationMethods(out, lce, preamble.toString(), body.toString(), false,
        ...
        out.println("        System.err.println(\"The \\\"testFrom\\\" clause "
                + "was not used in the learning classifier expression " + "that\");");
        ...
        out.println("      System.err.println(\"     * <parser> must be the "
                + "fully qualified class name of a Parser, or " + "\\\"null\\\"\");");
        ...
        out.println("      System.err.println(\"     * <input file> is the "
                + "relative or absolute path of a file, or \\\"null\\\" " + "to\");");
        ...
        out.println("      System.err.println(\"       file> can also be "
                + "non-\\\"null\\\" when <parser> is \\\"null\\\" (when the " + "parser\");");
        ...
        out.println("      testParser = "
                + "edu.cs.cogcomp.lbjava.util.ClassUtils.getParser(testParserName, new "
        ...
        Class lceClass = AST.globalSymbolTable.classForName(lce.learnerName.toString());
        if (lceClass == null) {
            reportError(lce.line, "Could not locate class for learner '" + lce.learnerName + "'.");
            return;
        }
        ...
        for (int i = 0; i < methods.length; ++i) {
            ...
            if (Arrays.binarySearch(noOverride, sig) >= 0)
                continue;
        ...
        if (lce.parameterSets.size() == 0) {
            ...
            if (lce.learnerParameterBlock != null) {
                ...
                out.println("    public Parameters() { super((" + lce.learnerName
                        + ".Parameters) new " + lceName + "(false).getParameters()); }");
            out.println("  }");
        }
    }
    ...
    /**
     * This method generates a string signature of the given method. The arguments other than
     * <code>m</code> are supplied as arguments for efficiency reasons, since this method is only
     * called by one other method.
     *
     ...
     * @return A string description of the method suitable for comparison with the elements of the
     *         {@link #noOverride} array.
     **/
    @SuppressWarnings("rawtypes")
    public static String signature(Method m, int modifiers, Class returned, String name,
            Class[] parameters) {
    ...
    /**
     * The value returned by the <code>Class.getName()</code> method is not recognizable as a type
     * by <code>javac</code> if the given class is an array; this method produces a representation
     * that is recognizable by <code>javac</code>. This method also replaces '$' characters with '.'
     * characters, under the assumption that '$' only appears in the name of an inner class.
     *
     * @param name The name of a class as produced by <code>Class.getName()</code>.
     * @return A string representation of the class recognizable by <code>javac</code>.
     **/
    public static String makeTypeReadable(String name) {
        ...
        switch (name.charAt(0)) {
            case 'B':
                return "boolean" + name.substring(1);
            case 'C':
                return "char" + name.substring(1);
            case 'D':
                return "double" + name.substring(1);
            case 'F':
                return "float" + name.substring(1);
            case 'I':
                return "int" + name.substring(1);
            case 'J':
                return "long" + name.substring(1);
            case 'L':
                int colon = name.indexOf(';');
                return name.substring(1, colon) + name.substring(colon + 1);
            case 'S':
                return "short" + name.substring(1);
            case 'Z':
                return "boolean" + name.substring(1);
        }
    ...
    /**
     * Generate code that overrides the methods of {@link Classifier} that return type information.
    ...
    public static void typeReturningMethods(PrintStream out, Type input, ClassifierReturnType output) {
        out.println("  public String getInputType() { return \"" + input.typeClass().getName()
                + "\"; }");
        out.println("  public String getOutputType() { return \"" + output.getTypeName() + "\"; }");
        ...
        if (output.values.size() > 0) {
            ...
            out.println("  public static String[] getAllowableValues() { return "
                    + "__allowableValues; }");
            out.println("  public String[] allowableValues() { return " + "__allowableValues; }");
        }
    }


    /**
     * Generates code that overrides the {@link Classifier#classify(Object[])} method so that it
     ...
     **/
    public static void typeCheckClassifyArray(PrintStream out, String name, Type input, int line) {
        out.println("  public FeatureVector[] classify(Object[] examples)");
        out.println("  {");
        out.print(generateTypeChecking("    ", name, "Classifier", true, input.toString(), line,
                "examples", false));
    ...
    /**
     * Generates the <code>equals(Object)</code> method, which evaluates to <code>true</code>
     * whenever the two objects are of the same type. This method should not be called when
     * generating code for a {@link InferenceDeclaration}.
     *
     * @param out The stream to write to.
     * @param name The name of the node whose <code>equals(Object)</code> method is being generated.
     **/
    public static void generateHashingMethods(PrintStream out, String name) {
        out.println("  public int hashCode() { return \"" + name + "\".hashCode(); }");
        out.println("  public boolean equals(Object o) { return o instanceof " + name + "; }");
    }


    /**
     * Generates the code appearing at the beginning of, for example, many classifiers'
     * {@link Classifier#classify(Object)} methods that checks to see if that input
     * <code>Object</code> has the appropriate type.
     *
     * @param indent The whitespace indentation in the generated code.
     * @param name The name of the {@link CodeGenerator} whose input is being checked.
     * @param type The type of {@link CodeGenerator} whose input is being checked (capitalized).
     * @param array Whether or not the method being type checked takes an array of the input type.
     * @param input The correct input type of the {@link CodeGenerator}.
     * @param line The line number on which the {@link CodeGenerator} appears.
     * @param exampleName The name of the example variable.
     * @param preExtracted Whether or not the generated code should allow object arrays containing
     *        indexed features, as a learner can take as input.
     * @return The generated code.
     **/
    public static StringBuffer generateTypeChecking(String indent, String name, String type,
            boolean array, String input, int line, String exampleName, boolean preExtracted) {
     ...
     * @param ref Code referring to an instance of the classifier from which package and name
     *        information will be taken for this feature.
     * @param id Code that evaluates to the value of the feature's identifier.
     * @param value Code that evaluates to the feature's value if <code>array</code> is
     *        <code>false</code>, or the array containing the feature's value if <code>array</code>
     *        is <code>true</code>.
     * @param index Code that evaluates to the array index of this feature. This parameter is
     *        ignored if it is <code>null</code> or <code>array</code> is <code>false</code>.
     * @param values Code that evaluates to the number of possible values that the feature can take.
     *        If set to <code>null</code>, <code>"allowableValues().length"</code> is substituted.
     *        This parameter is ignored if <code>array</code> is <code>false</code>.
     * @param arrayInfo Code that evaluates to both the index and length arguments in a feature
     *        constructor, separated by a comma. If this parameter is <code>null</code>, it defaults
     *        to <code>index</code> followed by <code>value</code> with <code>".length"</code>
     *        appended.
     **/
    private static String primitiveFeatureConstructorInvocation(boolean discrete, boolean array,
            String ref, String id, String value, String index, String values, String arrayInfo) {
    ...
    /**
     * This method generates the methods that return the features and values representing a
     * classification. Implementations generated here take care of all caching we may want to take
     * place. The explicitly overridden methods are a subset (depending on the classifier's type)
     * of:
     *
     * <ul>
     * <li> <code>classify(Object)</code></li>
     ...
     *
     * <p>
     * If <code>bodyPrimitive</code> is <code>true</code>, <code>body</code> should implement a
     * method that the caller assumes takes the same argument as the generated classifier and
     * returns the appropriate primitive type (<code>String</code> or <code>double</code>) via a
     * <code>return</code> statement. Otherwise, <code>body</code> should implement a method whose
     * argument is <code>Object
     * __example</code> and which stores the result of its computation in a variable named
     * <code>__result</code> which has already been declared to have either type
     * {@link Feature} or
     * {@link FeatureVector} as appropriate.
     *
     * <p>
     * If <code>post</code> is non-<code>null</code>, the code therein will have access to the
     * values computed by <code>body</code>. If <code>bodyPrimitive</code> is <code>true</code>,
     * those values can be accessed via a primitive variable named <code>__cachedValue</code>.
     * Otherwise, they must be accessed via the aforementioned <code>__result</code> variable.
     *
     * @param out The stream to write to.
     * @param classifierExp The classifier for which code is being generated.
     * @param preamble This code will be executed before any call to any of the generated methods.
     *        Any occurrences of the string <code>"$METHOD$"</code> (without the quotes) inside
     *        <code>preamble</code> will be replaced with the name of the method inside which code
     *        is currently being placed. If left <code>null</code>, it defaults to the code
     *        generated by
     *        {@link #generateTypeChecking(String,String,String,boolean,String,int,String,boolean)}.
     * @param body Generated code that computes the classification result (in a
     *        <code>FeatureVector</code>, <code>Feature</code>, <code>String</code>, or
     *        <code>double</code> as appropriate).
     * @param bodyPrimitive Set to <code>true</code> if the code in <code>body</code> computes a
     *        single <code>String</code> or <code>double</code>.
     * @param bodyArgCast Set to <code>true</code> if the code in <code>body</code> assumes the
     *        classifier's argument in the original source code will be in scope.
     * @param post Generated code that performs any post-processing that may be necessary on the
     *        computed classification result before it is finally returned. This parameter can be
     *        <code>null</code> if post-processing is not necessary.
     **/
    private static void generateClassificationMethods(PrintStream out,
            ClassifierExpression classifierExp, String preamble, String body,
            boolean bodyPrimitive, boolean bodyArgCast, String post) {
        String name = classifierExp.name.toString();
        Argument arg = classifierExp.argument;
        String input = arg.getType().toString();
        String field = classifierExp.cacheIn == null ? null : classifierExp.cacheIn.toString();
        ...
        if (array)
            valueMethodName += "Array";
        String cachedMethodReturnType = "Feature";
        if (array || generator)
            cachedMethodReturnType += "Vector";

        if (preamble == null)
            preamble =
                    generateTypeChecking("    ", name, "Classifier", false, input,
                            classifierExp.line, "__example", false).toString();
        ...
        if (anyCache || !bodyPrimitive) {
            ...
            if (field != null) {
                ...
                if (cachedInMap) {
                    if (!array && !discrete)
                        out.println("__dValue == null ? Double.NaN : " + "__dValue.doubleValue();");
                    else
                        out.println("(" + cachedValueType + ") __valueCache.get(__example);");
                } else
                    out.println(field + ";");

                out.print("\n    if (");
                if (!array && !discrete)
                    out.print("Double.doubleToLongBits(");
                ...
                out.print(primitiveFeatureConstructorInvocation(discrete, array, "", "\"\"",
                        "__cachedValue", "i", null, null));
            ...
            if (bodyPrimitive) {
                if (field != null) {
                    ...
                    out.println("    " + primitiveType + " __cachedValue = _" + valueMethodName
                            + "(__example);");
                ...
                out.println("    Feature __result = "
                        + primitiveFeatureConstructorInvocation(discrete, false, "", "\"\"",
                                "__cachedValue", null, null, null) + ";");
            } else {
                if (!anyCache)
                    out.print(preamble.replaceAll("\\$METHOD\\$", (array || generator ? "classify"
                            : "featureValue")));
                ...
                if (field != null) {
                    ...
                    out.println("__result."
                            + (array ? valueMethodName : (discrete ? "getStringValue"
                                    : "getStrength")) + "();");
        ...
        if (anyCache || !(array || generator)) {
            ...
            out.print("    return ");
            if (!(array || generator))
                out.print("new FeatureVector(");
            out.print((anyCache ? "cachedFeatureValue" : "featureValue") + "(__example)");
            if (!(array || generator))
                out.print(")");
            out.println(";");
            out.println("  }");
        ...
        if (!generator) {
            if (!array && (anyCache || bodyPrimitive)) {
                ...
                if (anyCache)
                    ...
                    out.println("    " + cachedValueType + " result = " + valueMethodName
                            + "(__example);");
                    out.println("    return "
                            + primitiveFeatureConstructorInvocation(discrete, false, "", "\"\"",
                ...
                if (array && field != null) {
                    ...
                    out.println("    return "
                            + (cachedInMap ? "(" + cachedValueType
                                    + ") __valueCache.get(__example)" : field) + ";");
                } else if (!anyCache && bodyPrimitive && post != null) {
                    out.print(preamble.replaceAll("\\$METHOD\\$", valueMethodName));
                    out.println("    " + cachedValueType + " __cachedValue = _" + valueMethodName
                            + "(__example);\n");
                    out.println(post);
                    out.println("    return __cachedValue;");
                } else
                    out.println("    return "
                            + (anyCache ? "cachedFeatureValue" : (array ? "classify"
                                    : "featureValue"))
                            + "(__example)."
                            + (array ? valueMethodName : (discrete ? "getStringValue"
                                    : "getStrength")) + "();");
            ...
            if (bodyPrimitive) {
                ...
                out.println("\n  " + (helper ? "private" : "public") + " " + cachedValueType + " "
                        + (helper ? "_" : "") + valueMethodName + "(Object __example)");
                out.println("  {");
                if (!helper)
                    out.print(preamble.replaceAll("\\$METHOD\\$", valueMethodName));
                if (bodyArgCast)
    ...
    /**
     * Compress the textual representation of an {@link ASTNode}, convert to ASCII hexadecimal, and
    ...
    public static void compressAndPrint(StringBuffer buffer, PrintStream out) {
        ...
        try {
            converter = new PrintStream(new GZIPOutputStream(new HexOutputStream(converted)));
        } catch (Exception e) {
     ...
     * {@link ClassifierExpression} on the right hand side of the arrow (and there really shouldn't
    ...
    public void run(ClassifierName cn) {
        ...
        if (cn.name == cn.referent
                || !RevisionAnalysis.revisionStatus.get(cnName).equals(RevisionAnalysis.REVISED))
            return;
        ...
        out.println("\n");
        if (cn.comment != null)
            out.println(cn.comment);

        out.println("public class " + cnName + " extends Classifier");
        out.println("{");

        if (cachedInMap)
            out.println("  private static final WeakHashMap __valueCache " + "= new WeakHashMap();");

        String referentNoDots = cn.referent.toString().replace('.', '$');
        out.println("  private static final " + cn.referent + " __" + referentNoDots + " = new "
                + cn.referent + "();\n");
        ...
        generateClassificationMethods(out, cn, null, body.toString(), false, false, null);
        out.println();
    ...
    public void run(CodedClassifier cc) {
        ...
        if (!RevisionAnalysis.revisionStatus.get(ccName).equals(RevisionAnalysis.REVISED))
            return;
        ...
        if (primitive) {
            ...
            if (cc.returnType.type == ClassifierReturnType.DISCRETE_ARRAY
                    ...
                    || cc.returnType.type == ClassifierReturnType.REAL_GENERATOR) {
                body.append("    ");
                body.append(cc.returnType.type == ClassifierReturnType.DISCRETE_ARRAY
                        || cc.returnType.type == ClassifierReturnType.DISCRETE_GENERATOR ? "String"
                        : "double");
                body.append(" __value;\n");
            }
        ...
        generateClassificationMethods(out, cc, null, body.toString(), primitive, true,
    ...
    public void run(CompositeGenerator cg) {
        ...
        if (fileName.indexOf("$$") != -1) {
            ...
            File[] leftOvers =
                    new File(System.getProperty("user.dir")).listFiles(new FilenameFilter() {
        ...
        if (!RevisionAnalysis.revisionStatus.get(cgName).equals(RevisionAnalysis.REVISED))
            return;
...

        {
            ...
            for (ClassifierExpressionList.ClassifierExpressionListIterator I =
                ...
                if (declared.add(name)) {
                    ...
                    if (isField(ce)) {
                        String fieldClass =
                                AST.globalSymbolTable.classForName(ce.name).getSimpleName();
                        out.println("  private static final " + fieldClass + " __" + nameNoDots
                                + " = " + fieldClass + "." + name + ";");
                    } else {
        ...
        generateClassificationMethods(out, cg, null, body.toString(), false, false, null);
        out.println();
        ...
        out.println("\n  public java.util.LinkedList getCompositeChildren()");
        out.println("  {");
        out.println("    java.util.LinkedList result = new " + "java.util.LinkedList();");
    ...
    public void run(InferenceInvocation ii) {
        ...
        if (!RevisionAnalysis.revisionStatus.get(iiName).equals(RevisionAnalysis.REVISED))
            return;
        ...
        out.println("  private static final " + iiClassifierName + " __" + iiClassifierName
                + " = new " + iiClassifierName + "();\n");
        ...
        if (ast.symbolTable.containsKey(ii.inference) && ast.symbolTable.getPackage().length() != 0)
        ...
        generateClassificationMethods(out, ii, null, body.toString(), true, false, null);
        out.println();
    ...
    public void run(LearningClassifierExpression lce) {
        ...
        if ((lce.parser == null ? !RevisionAnalysis.revisionStatus.get(lceName).equals(
                RevisionAnalysis.REVISED) : RevisionAnalysis.revisionStatus.get(lceName).equals(
                RevisionAnalysis.UNAFFECTED)
                || lce.startingRound > 1)
        ...
        out.println("  {");
        out.println("    if (instance == null) instance = new " + lceName + "(true);");
        out.println("  }\n");
        ...
        if (lce.parameterSets.size() > 0) {
            ...
            if (lce.learnerParameterBlock == null)
                out.print(firstArgumentsString);
            else
                out.print("new Parameters()");
            out.println("); }");
            ...
            if (lce.learnerParameterBlock == null)
                out.print(formalParameterString);
            else
                out.print("Parameters parameters");
            out.println(")");
            out.println("  {");
            out.print("    super(");
        ...
        if (lce.parameterSets.size() > 0) {
            ...
            if (lce.learnerParameterBlock != null) {
                ...
                out.println("    {");
                out.println("      super((" + lce.learnerName + ".Parameters) new " + lceName + "("
                        + argumentString + ").getParameters());");
                out.println("    }");
            }
            out.println("  }");
        }
    ...
    public void run(Conjunction c) {
        ...
        if (!RevisionAnalysis.revisionStatus.get(cName).equals(RevisionAnalysis.REVISED))
            return;
        ...
        out.println("  private static final " + leftName + " left = new " + leftName + "();");
        if (!leftName.equals(rightName))
            out.println("  private static final " + rightName + " right = new " + c.right.name
                    + "();\n");
        ...
        boolean leftIsPrimitive =
                leftType == ClassifierReturnType.DISCRETE || leftType == ClassifierReturnType.REAL;
        ...
        if (primitive)
            ...
            if (leftIsPrimitive)
                ...
                body.append("    FeatureVector leftVector = left.classify(__example);\n"
            ...
            if (c.left.equals(c.right)) {
                ...
                if (rightIsPrimitive)
                    ...
                    body.append("    FeatureVector rightVector = right.classify(__example);\n"
            ...
            if (bothMulti)
                body.append("    __result.sort();\n");
        }

        generateClassificationMethods(out, c, null, body.toString(), false, false, null);
        out.println();
    ...
    public void run(ConstraintDeclaration cd) {
        ...
        if (!RevisionAnalysis.revisionStatus.get(cdName).equals(RevisionAnalysis.REVISED))
            return;
        ...
        out.println("\n");
        if (cd.comment != null)
            out.println(cd.comment);

        out.println("public class " + cdName + " extends ParameterizedConstraint");
        out.println("{");
        ...
        out.println("  {");
        out.print(generateTypeChecking("    ", cdName, "Constraint", false, input.toString(),
                cd.line, "__example", false));
        ...
        out.println("    " + cd.argument + " = (" + input + ") __example;");
        out.println("    FirstOrderConstraint __result = new " + "FirstOrderConstant(true);\n");
    ...
    public void run(InferenceDeclaration in) {
        ...
        if (!RevisionAnalysis.revisionStatus.get(inName).equals(RevisionAnalysis.REVISED))
            return;
        ...
        out.println(");");
        out.println("    constraint = new " + in.constraint.name + "().makeConstraint(head);");
        out.println("  }\n");
        ...
        for (int i = 1; i < in.headFinders.length; ++i)
            out.print(", \"" + in.headFinders[i].argument.getType().typeClass().getName() + "\"");
        out.println(" };");
        out.println("  }\n");
        ...
        if (in.containsTypeSpecificNormalizer()) {
            ...
            out.println("    return " + defaultNormalizer + ";");
    ...
    /**
     * If the given expression can be converted to a string at compile time, this method returns
     * that string.
     *
     * @param e The given expression.
     * @return The compile time conversion of the expression to a string, or <code>null</code> if it
     *         wasn't possible to convert.
     **/
    private static String toStringLiteral(Expression e) {
        if (e instanceof Constant) {
            Constant c = (Constant) e;
            if (c.typeCache instanceof PrimitiveType)
                return "\"" + c.value + "\"";
            return c.value;
        }
    ...
    public void run(SenseStatement ss) {
        ...
        if (ss.value instanceof MethodInvocation) {
            ...
            if (m.isClassifierInvocation) {
                ClassifierReturnType invokedType = ((ClassifierType) m.name.typeCache).getOutput();
                int t = invokedType.type;

                if ((currentCC.returnType.type == ClassifierReturnType.DISCRETE_GENERATOR || currentCC.returnType.type == ClassifierReturnType.REAL_GENERATOR)
                        && (t == ClassifierReturnType.DISCRETE_GENERATOR
                                || t == ClassifierReturnType.REAL_GENERATOR
                                || t == ClassifierReturnType.DISCRETE_ARRAY || t == ClassifierReturnType.REAL_ARRAY)) {
                    appendIndent("__id = ");
                    ...
                    appendIndent("}");
                    return;
                } else if ((currentCC.returnType.type == ClassifierReturnType.DISCRETE_ARRAY || currentCC.returnType.type == ClassifierReturnType.REAL_ARRAY)
                        && (t == ClassifierReturnType.DISCRETE_ARRAY || t == ClassifierReturnType.REAL_ARRAY)) {
                    appendLine("{");
                    ++indent;
                    ...
                    methodBody.append(primitiveFeatureConstructorInvocation(isDiscrete, true,
                            "this", "\"\"", "__value", null,
                            "" + currentCC.returnType.values.size(), "__featureIndex++, 0"));
                    methodBody.append(");\n");
        ...
        if (ss.senseall) {
            if (ss.name != null) { // if we're inside a generator
                ...
                appendLine("for (java.util.Iterator __I = ((java.util.Collection) "
                ...
                appendLine("{");
                ++indent;
                appendLine("for (java.util.Iterator __I = ((java.util.Map) "
                        + "__values).entrySet().iterator(); __I.hasNext(); )");
                appendLine("{");
                ++indent;
                appendLine("java.util.Map.Entry __e = (java.util.Map.Entry) __I.next();");
                appendLine("__id = __e.getKey().toString();");
                appendIndent("__value = ");
                methodBody.append(discrete ? "__e.getValue().toString()"
                ...
                appendIndent("__value = ");
                methodBody.append(discrete ? "__I.next().toString()"
    ...
    /**
     * Generates the statement that adds a new feature of the appropriate type to the returned
     * <code>FeatureVector</code> when a <code>sense</code> statement is executed. The code
     * generated by this method assumes the following:
     * <ul>
     * <li>
     * if the containing classifier is a generator, code has already been generated to set the value
     * of a string named <code>__id</code> representing the identifier of the new feature and
     * <li>
     * if <code>value</code> is <code>null</code>, code has already been generated to set the value
     * of a string or double as appropriate named <code>__value</code> representing the value of the
     * new feature.
     * </ul>
     *
     ...
     * @param value Generated code evaluating to the new feature's value. If this parameter is
     *        <code>null</code>, it will default to <code>"__value"</code>.
     **/
    private void senseFeature(SenseStatement s, CodedClassifier cc, boolean discrete, String value) {
        appendIndent("__result.addFeature(");
        boolean array = s.name == null;
        String id = array ? "\"\"" : "__id";
        if (value == null)
            value = "__value";
        methodBody.append(primitiveFeatureConstructorInvocation(discrete, array, "this", id, value,
                null, "" + cc.returnType.values.size(), "__featureIndex++, 0"));
        methodBody.append(");");
    }
    ...
    /**
     * This method generates the code for a new temporary variable used when translating
     * constraints.
     *
    ...
    private void constraintTemporary(String name) {
        appendIndent();
        if (constraintMode)
            methodBody.append("FirstOrderConstraint ");
        else
            methodBody.append("boolean ");
    ...
    public void run(BinaryConstraintExpression e) {
        ...
        if (constraintMode || e.operation.operation == Operator.DOUBLE_IMPLICATION) {
            ...
            if (constraintMode) {
                ...
                if (e.operation.operation == Operator.LOGICAL_CONJUNCTION)
                    ...
                    methodBody.append("DoubleImplication");
    ...
    public void run(NegatedConstraintExpression e) {
        ...
        methodBody.append(" = ");
        if (constraintMode)
            methodBody.append("new FirstOrderNegation(");
        else
            methodBody.append("!");
        methodBody.append(childResultName);
        if (constraintMode)
    ...
    /**
     * Generates the code necessary at the top of a replacer method implementation to declare the
     * variables that will be used in the method.
     *
    ...
    private void generateReplacerMethodEnvironment(Expression expression) {
        for (Iterator<Argument> I = expression.getVariableTypes().iterator(); I.hasNext();) {
            ...
            if (primitiveTypeName == null)
                ...
                methodBody.append("(" + primitiveTypeName);
            methodBody.append(") ");

            if (type.quantifierArgumentType) {
                methodBody.append("quantificationVariables.get(");
                methodBody.append(((Integer) quantificationVariables.get(a.getName())).intValue());
                methodBody.append(")");
            } else {
                methodBody.append("context[");
                methodBody.append(((Integer) contextVariables.get(a.getName())).intValue());
                methodBody.append("]");
            }
    ...
    /**
     * Translates an expression from a quantified {@link ConstraintEqualityExpression} into the
     * appropriate method of an {@link EqualityArgumentReplacer}.
     *
     * @param right Indicates if <code>expression</code> comes from the right hand side of the
     *        equality.
     * @param expression The expression.
     * @param isDiscreteLearner This flag is set if <code>expression</code> represents a variable.
     **/
    private void generateEARMethod(boolean right, Expression expression, boolean isDiscreteLearner) {
        appendIndent("public ");
    ...
    /**
     * Translates an unquantified expression not representing a first order variable from a
     * {@link ConstraintEqualityExpression} into an argument of a {@link FirstOrderEquality}.
     *
     * @param left This flag is set if <code>expression</code> came from the left hand side of the
     *        equality.
     * @param expression The expression.
     **/
     ...
     *
     * @param expression The expression.
     * @param isQuantified This flag is set if <code>expression</code> contains a quantified
     *        variable.
     **/
    ...
    public void run(ConstraintEqualityExpression e) {
            ...
            if (constraintMode) {
                ...
                if (leftIsDiscreteLearner) {
                    if (rightIsDiscreteLearner)
                        ...
                        methodBody.append("EqualityWithValue");
                    methodBody.append("(");
        ...
        if (leftIsDiscreteLearner) {
            if (rightIsDiscreteLearner)
                methodBody.append("WithVariable");
            else
                methodBody.append("WithValue");
        } else
            methodBody.append("TwoValues");

        methodBody.append("(");
        methodBody.append(e.operation.operation == Operator.CONSTRAINT_EQUAL);
        methodBody.append(", ");
        if (leftIsDiscreteLearner)
            generateVariable(left, leftIsQuantified);
        else if (leftIsQuantified)
            methodBody.append("null");
        else
            generateNotVariable(true, left);
        methodBody.append(", ");
        if (rightIsDiscreteLearner)
            generateVariable(right, rightIsQuantified);
        else if (rightIsQuantified)
            methodBody.append("null");
        else
            generateNotVariable(false, right);
    ...
    /**
     * {@link UniversalQuantifierExpression}s and {@link ExistentialQuantifierExpression}s generate
     * their code through this method.
     *
     * @param e The node to process.
     **/
    private void generateSimpleQuantifier(QuantifiedConstraintExpression e) {
        ...
        quantificationVariables.put(e.argument.getName(), new Integer(quantifierNesting++));
        e.constraint.runPass(this);
        --quantifierNesting;
    ...
    /**
     * {@link AtLeastQuantifierExpression}s and {@link AtMostQuantifierExpression}s generate their
    ...
    public void generateBoundedQuantifier(QuantifiedConstraintExpression e) {
        ...
        if (atleast)
            ale = (AtLeastQuantifierExpression) e;
        else
            ame = (AtMostQuantifierExpression) e;
        ...
        if (!constraintMode) {
            ...
            methodBody.append(" = ");
            if (atleast)
                ale.lowerBound.runPass(this);
            else
                ame.upperBound.runPass(this);
            methodBody.append(";\n");
        ...
        if (!(e.collectionIsQuantified || atleast && ale.lowerBoundIsQuantified || !atleast
                && ame.upperBoundIsQuantified)) {
            appendIndent(myResultName);
            methodBody.append(" = new ");
            if (atleast)
                methodBody.append("AtLeast");
            else
                methodBody.append("AtMost");
            methodBody.append("Quantifier(\"");
            methodBody.append(e.argument.getName());
            methodBody.append("\", ");
            e.collection.runPass(this);
            ...
            methodBody.append(", ");
            if (atleast)
                methodBody.append(ale.lowerBound);
            else
                methodBody.append(ame.upperBound);
            methodBody.append(");\n");
        } else {
            appendLine("QuantifierArgumentReplacer LBJ$QAR =");
            ++indent;
            ...
            if (atleast && ale.lowerBoundIsQuantified || !atleast && ame.upperBoundIsQuantified) {
                if (e.collectionIsQuantified)
                    methodBody.append("\n");
                ...
                if (atleast)
                    generateReplacerMethodEnvironment(ale.lowerBound);
                else
                    generateReplacerMethodEnvironment(ame.upperBound);
