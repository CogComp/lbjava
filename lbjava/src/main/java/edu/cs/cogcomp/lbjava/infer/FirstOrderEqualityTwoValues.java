...
public class FirstOrderEqualityTwoValues extends FirstOrderEquality {
     ...
     **/
    public FirstOrderEqualityTwoValues(boolean e, String l, String r, EqualityArgumentReplacer ear) {
        super(e, ear);
        left = l;
        right = r;
    }
    ...
    public boolean evaluate() {
        return equality == left.equals(right);
    }
    ...
    /**
     * The hash code of a <code>FirstOrderEqualityTwoValues</code> is the sum of the hash codes of
     * its children.
     *
    ...
    /**
     * Two <code>FirstOrderEqualityTwoValues</code>s are equivalent when their children are
     * equivalent in either order.
     *
     * @return <code>true</code> iff the argument is a <code>FirstOrderEqualityTwoValues</code>
     *         involving the same children.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderEqualityTwoValues))
            return false;
