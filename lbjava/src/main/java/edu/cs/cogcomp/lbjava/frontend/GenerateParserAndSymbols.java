...
public class GenerateParserAndSymbols {
    ...
    public GenerateParserAndSymbols() {
        ...
        String sourcePath =
                getClass().getClassLoader().getResource("").getPath() + "../../src/main/";
        ...
        try {
            ...
            BufferedReader in =
                    new BufferedReader(new InputStreamReader(new FileInputStream(newSymFile)));
            String names = "";
            String line;
            ...
            BufferedWriter out =
                    new BufferedWriter(new OutputStreamWriter(new FileOutputStream(symNamesFile)));

            // Add the licence header
            String licence = "/**\n";
            in =
                    new BufferedReader(new InputStreamReader(new FileInputStream(sourcePath
            ...
            String output =
                    licence
                            + "package "
                            + packageName.replaceAll("/", ".").substring(0,
