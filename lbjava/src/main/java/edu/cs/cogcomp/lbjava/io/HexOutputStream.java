 ...
 * that text on to another <code>OutputStream</code>. The most common usage of this class will
 * involve passing it to the constructor of another <code>OutputStream</code>. For instance: <br>
 * <br>
 *
 * <pre>
...
public class HexOutputStream extends OutputStream {
     ...
     * and <code>b[off+len-1]</code> is the last byte written by this operation. <br>
     * <br>
     *
