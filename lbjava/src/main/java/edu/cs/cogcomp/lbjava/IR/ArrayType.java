...
public class ArrayType extends Type {
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the argument.
     *
    ...
    public Class typeClass() {
        if (myClass == null) {
            ...
            if (myClass != null) {
                try {
                    myClass = Array.newInstance(myClass, 0).getClass();
                } catch (Exception e) {
    ...
    /**
     * Two <code>ArrayType</code>s are equivalent if their child types are equivalent.
     *
     ...
     **/
    public Object clone() {
        return new ArrayType((Type) type.clone());
    }
