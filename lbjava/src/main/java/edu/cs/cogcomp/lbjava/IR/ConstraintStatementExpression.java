...
/**
 * This class is simply a wrapper for a <code>ConstraintExpression</code> so that it can be used in
 * an <code>ExpressionStatement</code>.
 *
 * @author Nick Rizzolo
 **/
public class ConstraintStatementExpression extends StatementExpression {
    ...
    /**
     * Full constructor. Line and byte offset information is taken from the lone argument.
     *
    ...
    public HashSet<Argument> getVariableTypes() {
        return constraint.getVariableTypes();
    }
     ...
     **/
    public Object clone() {
        return new ConstraintStatementExpression((ConstraintExpression) constraint.clone());
    }
