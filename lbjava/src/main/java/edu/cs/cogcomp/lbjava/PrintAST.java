...
/**
 * The <code>PrintAST</code> pass simply prints a text representation of the parsed AST to standard
 * output.
 *
 * @author Nick Rizzolo
 **/
public class PrintAST extends Pass {
     ...
     * <code>indent</code> member variable and followed by a new line.
     *
     ...
     * <code>indent</code> member variable and followed by the line number and byte offset
     * information for the specified <code>ASTNode</code> and a new line.
     *
     * @param text The text to print.
     * @param node The node for which to print line and byte offset information.
     **/
    ...
    public void run(Operator node) {
        indentedPrintln(node.toString(), node);
    }
    ...
    public void run(StatementList node) {
        nonTerminal("StatementList", node);
    }
    ...
    public void run(ReferenceType node) {
        nonTerminal("ReferenceType", node);
    }
    ...
    public void run(VariableDeclaration node) {
        ...
        ++indent;
        ExpressionList.ExpressionListIterator I = node.initializers.listIterator();
        while (I.hasNext()) {
