...
public class ForStatement extends Statement {
     ...
     **/
    public ForStatement(ExpressionList i, Expression c, ExpressionList u, Statement b, int line,
            int byteOffset) {
     ...
     *        code represented by this node is found.
     **/
    public ForStatement(VariableDeclaration v, Expression c, ExpressionList u, Statement b,
     ...
     **/
    public Object clone() {
        ExpressionList i = initializers == null ? null : (ExpressionList) initializers.clone();
        ...
        ExpressionList u = updaters == null ? null : (ExpressionList) updaters.clone();

        if (v == null)
            return new ForStatement(i, c, u, body, -1, -1);
    ...
    public int hashCode() {
        ...
        if (initializers != null)
            result += 47 * initializers.hashCode();
        if (initializer != null)
            result += 37 * initializer.hashCode();
        if (condition != null)
            result += 23 * condition.hashCode();
        if (updaters != null)
            result += 7 * updaters.hashCode();
        return result;
    }


    /**
     * Distinguishes this {@link ASTNode} from other objects according to its contents recursively.
     *
    ...
    public boolean equals(Object o) {
        ...
        return body.equals(f.body)
                && (initializers == null ? f.initializers == null : initializers
                        .equals(f.initializers))
                && (initializer == null ? f.initializer == null : initializer.equals(f.initializer))
                && (condition == null ? f.condition == null : condition.equals(f.condition))
                && (updaters == null ? f.updaters == null : updaters.equals(f.updaters));
    }
