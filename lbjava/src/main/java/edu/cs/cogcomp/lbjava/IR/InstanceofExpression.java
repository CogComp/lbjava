...
public class InstanceofExpression extends Expression {
    /**
     * (&not;&oslash;) The expression on the left hand side of <code>instanceof</code>.
     **/
    public Expression left;
    /**
     * (&not;&oslash;) The expression on the right hand side of <code>instanceof</code>.
     **/
    public Type right;
     ...
     **/
    public Object clone() {
        return new InstanceofExpression((Expression) left.clone(), (Type) right.clone(), -1, -1);
    }
