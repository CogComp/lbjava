...
/**
 * This class represents a conditional expression. Conditional expressions have the form
 * <code>(c ? t : e)</code>.
 *
 * @author Nick Rizzolo
 **/
public class Conditional extends Expression {
    ...
    /**
     * (&not;&oslash;) The expression to evaluate if the condition evaluates to <code>true</code>.
     **/
    public Expression thenClause;
    /**
     * (&not;&oslash;) The expression to evaluate if the condition evaluates to <code>false</code>.
     **/
     ...
     * @param t The expression to evaluate if the condition is <code>true</code>.
     * @param e The expression to evaluate if the condition is <code>false</code>.
     ...
     **/
    public Conditional(Expression c, Expression t, Expression e, int line, int byteOffset) {
     ...
     **/
    public int hashCode() {
        return condition.hashCode() + thenClause.hashCode() + elseClause.hashCode();
    }
     ...
     **/
    public Object clone() {
        return new Conditional((Expression) condition.clone(), (Expression) thenClause.clone(),
