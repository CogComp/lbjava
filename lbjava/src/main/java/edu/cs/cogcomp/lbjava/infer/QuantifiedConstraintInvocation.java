...
public class QuantifiedConstraintInvocation extends FirstOrderConstraint {
     ...
     **/
    public QuantifiedConstraintInvocation(ParameterizedConstraint p, InvocationArgumentReplacer iar) {
        parameterized = p;
        replacer = iar;
    }
     ...
     * <code>setQuantificationVariables(Vector)</code>, <code>false</code> will be returned.
     **/
    ...
    public void setQuantificationVariables(Vector o) {
        if (replacer == null) {
            System.err.println("LBJava ERROR: Attempting to set quantification variable with no "
    ...
    /**
     * If this method is called without first calling
     * <code>setQuantificationVariables(Vector)</code>, the constant representing <code>false</code>
     * will be returned.
     *
    ...
    /**
     * The hash code of a <code>QuantifiedConstraintInvocation</code> is the sum of the hash codes
     * of its children.
     *
     * @return The hash code for this <code>QuantifiedConstraintInvocation</code>.
     **/
    public int hashCode() {
    ...
    /**
     * Two <code>QuantifiedConstraintInvocation</code>s are equivalent when their children are
     * equivalent.
     *
    ...
    public boolean equals(Object o) {
        if (!(o instanceof QuantifiedConstraintInvocation))
            return false;
