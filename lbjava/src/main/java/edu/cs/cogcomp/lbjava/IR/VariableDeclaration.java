...
public class VariableDeclaration extends Statement {
    ...
    /**
     * (&not;&oslash;) The initializing expressions for the declared variables, <code>null</code>
     ...
     **/
    public VariableDeclaration(Name n) {
        this(n, null);
    }
     ...
     **/
    public Object clone() {
        return new VariableDeclaration((Type) type.clone(), (NameList) names.clone(),
    ...
    public int hashCode() {
        return (isFinal ? 1 : 3) + 7 * type.hashCode() + 17 * names.hashCode() + 31
    ...
    public boolean equals(Object o) {
        ...
        return isFinal == v.isFinal && type.equals(v.type) && names.equals(v.names)
