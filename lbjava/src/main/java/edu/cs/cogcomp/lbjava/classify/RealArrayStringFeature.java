...
public class RealArrayStringFeature extends RealPrimitiveStringFeature {
     ...
     **/
    public RealArrayStringFeature(String p, String c, String id, double v, int i, int l) {
        super(p, c, id, v);
        arrayIndex = i;
        arrayLength = l;
    }
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        return new RealArrayStringFeature(containingPackage, generatingClassifier, identifier, 0,
                arrayIndex, 0);
    }
    ...
    /**
     * Returns a new feature object, the same as this one in all respects except the {@link #value}
    ...
    public RealFeature multiply(double m) {
        return new RealArrayStringFeature(containingPackage, generatingClassifier, identifier,
                value * m, arrayIndex, arrayLength);
    }
    ...
    public Feature withStrength(double s) {
        return new RealArrayStringFeature(containingPackage, generatingClassifier, identifier, s,
    ...
    public Feature encode(String e) {
        ...
        return new RealArrayFeature(containingPackage, generatingClassifier, id, value, arrayIndex,
                arrayLength);
    }


    /**
     * The hash code of a <code>RealArrayStringFeature</code> is the sum of the hash codes of the
     * containing package, the identifier, the value, and the array index.
     *
     * @return The hash code for this <code>Feature</code>.
     **/
    public int hashCode() {
        return 17 * super.hashCode() + arrayIndex;
    }


    /**
     * Two <code>RealArrayStringFeature</code>s are equivalent when their containing packages,
    ...
    public boolean equals(Object o) {
        return super.equals(o)
                && (o instanceof RealArrayStringFeature ? arrayIndex == ((RealArrayStringFeature) o).arrayIndex
