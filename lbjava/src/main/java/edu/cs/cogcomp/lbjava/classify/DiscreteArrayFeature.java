...
public class DiscreteArrayFeature extends DiscretePrimitiveFeature {
     ...
     * @param l The length of the array this feature is contained in.
     **/
    public DiscreteArrayFeature(String p, String c, ByteString id, ByteString v, short vi, short t,
            int i, int l) {
        super(p, c, id, v, vi, t);
        arrayIndex = i;
        arrayLength = l;
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        if (totalValues() == 2)
            return new DiscreteArrayFeature(containingPackage, generatingClassifier, identifier,
                    ByteString.emptyString, (short) -1, (short) 2, getArrayIndex(), 0);
        return this;
    }
    ...
    public RealFeature makeReal() {
        if (totalValues == 2)
            return new RealArrayFeature(containingPackage, generatingClassifier, identifier,
            ...
            id.append(toAppend);
            return new RealArrayFeature(containingPackage, generatingClassifier, id, 1, arrayIndex,
                    arrayLength);
        }
    }
    ...
    public Feature withStrength(double s) {
        if (totalValues != 2 || !(s == 0 || s == 1))
            return null;
        return new DiscreteArrayFeature(containingPackage, generatingClassifier, identifier,
                ByteString.emptyString, (short) Math.round(s), (short) 2, arrayIndex, arrayLength);
    }


    /**
     * The hash code of a <code>DiscreteArrayFeature</code> is the sum of the hash codes of the
    ...
    /**
     * Two <code>DiscreteArrayFeature</code>s are equivalent when their containing packages,
    ...
    public boolean equals(Object o) {
        return super.equals(o)
                && (o instanceof DiscreteArrayFeature ? arrayIndex == ((DiscreteArrayFeature) o).arrayIndex
