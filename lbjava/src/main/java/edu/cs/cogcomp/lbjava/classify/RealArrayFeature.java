...
public class RealArrayFeature extends RealPrimitiveFeature {
     ...
     **/
    public RealArrayFeature(String p, String c, ByteString id, double v, int i, int l) {
        super(p, c, id, v);
        arrayIndex = i;
        arrayLength = l;
    }
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        return new RealArrayFeature(containingPackage, generatingClassifier, identifier, 0,
                arrayIndex, 0);
    }
    ...
    public RealFeature multiply(double m) {
        return new RealArrayFeature(containingPackage, generatingClassifier, identifier, value * m,
    ...
    public Feature withStrength(double s) {
        return new RealArrayFeature(containingPackage, generatingClassifier, identifier, s,
                arrayIndex, arrayLength);
    }


    /**
     * The hash code of a <code>RealArrayFeature</code> is the sum of the hash codes of the
    ...
    /**
     * Two <code>RealArrayFeature</code>s are equivalent when their containing packages,
    ...
    public boolean equals(Object o) {
        return super.equals(o)
                && (o instanceof RealArrayFeature ? arrayIndex == ((RealArrayFeature) o).arrayIndex
