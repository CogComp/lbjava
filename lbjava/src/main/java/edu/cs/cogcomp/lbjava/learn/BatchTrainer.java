...
import edu.cs.cogcomp.lbjava.parse.FoldSeparator;
import edu.cs.cogcomp.lbjava.parse.Parser;
import edu.cs.cogcomp.lbjava.util.StudentT;
...
public class BatchTrainer {
     ...
     * {@link ArrayFileParser} and {@link #lexiconSize} to 0 if
     ...
     * {@link ArrayFileParser}. This condition is easy to
     ...
     * {@link ArrayFileParser ArrayFileParser}. This condition
     ...
     * {@link ArrayFileParser ArrayFileParser}.
     *
     * <p>
     * It is assumed that <code>preExtractLearner</code> already knows where to write the lexicon.
     * If it doesn't, call {@link Learner#setLexiconLocation(String)} or
     ...
     * both an array of {@link Learner.Parameters} objects and
     * an array of rounds. As such, the value in the
     * {@link Learner.Parameters#rounds} field is ignored
     * during tuning. It is also overwritten in each of the
     * {@link Learner.Parameters} objects when the optimal
     ...
     * {@link Learner.Parameters} objects and an array of
