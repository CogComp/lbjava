...
abstract public class List extends ASTNode {
     ...
     *
     * @param c A comparator that determines the relative ordering of two elements in the list.
     **/
    ...
    public class NodeListIterator extends ASTNodeIterator {
        ...
        /**
         * Inserts the specified node into the list. The element is inserted immediately before the
         * next element that would be returned by <code>next()</code>, if any, and after the next
         * element that would be returned by <code>previous()</code>, if any. (If the list contains
         * no elements, the new element becomes the sole element on the list.) The new element is
         * inserted before the implicit cursor: a subsequent call to <code>next()</code> would be
         * unaffected, and a subsequent call to <code>previous()</code> would return the new
        ...
        /**
         * Returns <code>true</code> if this list iterator has more elements when traversing the
         * list in the forward direction.
         *
         * @return <code>true</code> if this list iterator has more elements when traversing the
         *         list in the forward direction.
         **/
         ...
         **/
        public ASTNode next() {
            return (ASTNode) I.next();
        }


        /**
         * Returns the index of the node that would be returned by a subsequent call to
         * <code>next()</code>. (Returns list size if the list iterator is at the end of the list.)
         *
         * @return The index of the element that would be returned by a subsequent call to
         *         <code>next()</code>, or list size if list iterator is at end of list.
         **/
        ...
        public ASTNode previous() {
            return (ASTNode) I.previous();
        }


        /**
         * Returns the index of the node that would be returned by a subsequent call to
         * <code>previous()</code>. (Returns -1 if the list iterator is at the beginning of the
         * list.)
         *
         * @return The index of the element that would be returned by a subsequent call to
         *         <code>previous()</code>, or -1 if list iterator is at the beginning of the list.
         **/
        ...
        /**
         * Removes from the list the last element that was returned by <code>next()</code> or
         * <code>previous</code>. This call can only be made once per call to <code>next()</code> or
         * <code>previous</code>. It can be made only if <code>add(ASTNode)</code> has not been
        ...
        /**
         * Replaces the last element returned by <code>next()</code> or <code>previous()</code> with
         * the specified element. This call can be made only if neither <code>remove()</code> nor
         * <code>add(ASTNode)</code> have been called after the last call to <code>next()</code> or
         * <code>previous()</code>.
         *
