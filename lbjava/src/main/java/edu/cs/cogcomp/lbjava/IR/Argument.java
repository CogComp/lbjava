...
public class Argument extends ASTNode {
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the type's
     * representation.
     *
    ...
    /**
     * The hash code of an <code>Argument</code> is simply the hash code of its name.
     **/
    public int hashCode() {
    ...
    /**
     * Two <code>Argument</code>s are equivalent when their names and types are equivalent.
     *
