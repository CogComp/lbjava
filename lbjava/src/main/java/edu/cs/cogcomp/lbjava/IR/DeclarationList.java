...
public class DeclarationList extends List {
     ...
     *
     * @param d A single <code>Declaration</code> with which to initialize this list.
     **/
    ...
    /**
     * Adds all the <code>Declaration</code>s in another <code>DeclarationList</code> to the end of
     * this <code>DeclarationList</code>.
     *
     * @param d The list to be added.
     **/
    public void addAll(DeclarationList d) {
        list.addAll(d.list);
    }
