...
/**
 * An "at most" quantifier states that the constraint must hold for no more than <i>m</i> of the
...
public class AtMostQuantifier extends Quantifier {
    ...
    public PropositionalConstraint propositionalize() {
        return new AtLeastQuantifier(quantificationVariable, collection, new FirstOrderNegation(
                constraint), collection.size() - m).propositionalize();
    }


    /**
     * The hash code of a <code>AtMostQuantifier</code> is the sum of the hash codes of its
     * children.
     *
    ...
    /**
     * Two <code>AtMostQuantifier</code>s are equivalent when their children are equivalent.
     *
     * @return <code>true</code> iff the argument is an equivalent <code>AtMostQuantifier</code>.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof AtMostQuantifier))
            return false;
