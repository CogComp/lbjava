...
/**
 * This abstract <code>Parser</code> does not define the <code>next()</code> method, but it does
 * define a constructor that opens the specified file and a <code>readLine()</code> method that
...
public abstract class LineByLine implements Parser {
    ...
    /**
     * Reads a line from the current buffer and returns it. When there are no more lines in the
     * input file, the stream is closed, and <code>null</code> will be returned by this method
     * thereafter. Returned strings do not contain line termination characters.
     *
     * @return The next line of text from the input file, or <code>null</code> if no more lines
     *         remain.
     **/
