...
public class UnaryExpression extends Expression {
    ...
    /**
     * Initializing constructor. Line and byte offset information is taken from the unary operator's
     * representation.
     *
    ...
    public boolean equals(Object o) {
        ...
        return operation.equals(u.operation) && subexpression.equals(u.subexpression);
    }
     ...
     **/
    public Object clone() {
        return new UnaryExpression((Operator) operation.clone(), (Expression) subexpression.clone());
    }
