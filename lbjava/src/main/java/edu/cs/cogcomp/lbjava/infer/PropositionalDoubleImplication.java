...
public class PropositionalDoubleImplication extends PropositionalBinaryConstraint {
     ...
     **/
    public PropositionalDoubleImplication(PropositionalConstraint l, PropositionalConstraint r) {
        super(l, r);
    }
    ...
    public PropositionalConstraint simplify() {
        return new PropositionalConjunction(new PropositionalDisjunction(left.negate(), right),
    ...
    public PropositionalConstraint negate() {
        return new PropositionalConjunction(new PropositionalDisjunction(left.negate(),
                right.negate()), new PropositionalDisjunction(left, right));
    }
    ...
    public PropositionalConstraint CNF() {
        return new PropositionalConjunction(new PropositionalDisjunction(new PropositionalNegation(
                left), right), new PropositionalDisjunction(new PropositionalNegation(right), left))
                .CNF();
    }
    ...
    public PropositionalConstraint DNF() {
        return new PropositionalDisjunction(new PropositionalConjunction(left, right),
                new PropositionalConjunction(new PropositionalNegation(left),
                        new PropositionalNegation(right))).DNF();
    }
    ...
    public boolean moreSpecificThan(PropositionalImplication c) {
        ...
        return left.equals(children[0]) && right.equals(children[1]) || left.equals(children[1])
    ...
    public boolean moreSpecificThan(PropositionalDisjunction c) {
        ...
        return children.length == 2
                && (new PropositionalNegation(left).equals(children[0])
                        ...
                        && right.equals(children[0]) || left.equals(children[0])
                        && new PropositionalNegation(right).equals(children[1]) || left
                        .equals(children[1])
    ...
    /**
     * The hash code of a <code>PropositionalDoubleImplication</code> is the sum of the hash codes
     * of its children plus three.
     *
     * @return The hash code for this <code>PropositionalDoubleImplication</code>.
     **/
    public int hashCode() {
    ...
    /**
     * Two <code>PropositionalDoubleImplication</code>s are equivalent when they are topologically
    ...
    public boolean equals(Object o) {
        if (!(o instanceof PropositionalDoubleImplication))
            return false;
        PropositionalDoubleImplication i = (PropositionalDoubleImplication) o;
        return left.equals(i.left) && right.equals(i.right) || left.equals(i.right)
                && right.equals(i.left);
    }
