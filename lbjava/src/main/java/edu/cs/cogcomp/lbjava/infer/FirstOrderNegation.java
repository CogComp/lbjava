...
public class FirstOrderNegation extends FirstOrderConstraint {
    ...
    /**
     * The hash code of a <code>FirstOrderNegation</code> is the hash code of its child constraint
     * plus 1.
     *
    ...
    /**
     * Two <code>FirstOrderNegation</code>s are equivalent when their constraints are equivalent.
     *
     * @return <code>true</code> iff the argument is a <code>FirstOrderNegation</code> of the same
     *         constraint.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderNegation))
            return false;
