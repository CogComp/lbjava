...
public class ExpressionList extends List {
    ...
    /**
     * Initializing constructor. Does not require its argument to be non-<code>null</code>.
     *
     * @param e A single <code>Expression</code> with which to initialize this list.
     **/
    ...
    /**
     * Initializing constructor. Does not require its first argument to be non-<code>null</code>,
     * however this is required of the second argument.
     *
     * @param e A single <code>Expression</code> with which to initialize this list.
     * @param l A list of <code>Expression</code>s which will also be added to the list.
     **/
    ...
    /**
     * Adds all the <code>Expression</code>s in another <code>ExpressionList</code> to the end of
     * this <code>ExpressionList</code>.
     *
     * @param e The list to be added.
     **/
    public void addAll(ExpressionList e) {
        list.addAll(e.list);
    }
    ...
    public boolean containsQuantifiedVariable() {
        for (ExpressionListIterator I = listIterator(); I.hasNext();)
            if (I.nextItem().containsQuantifiedVariable())
                return true;
        return false;
    }
     ...
     *
     * @return An array of expressions containing references to every expression in the list.
     **/
