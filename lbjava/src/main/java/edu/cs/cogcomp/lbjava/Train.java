...
import edu.cs.cogcomp.lbjava.learn.TestingMetric;
import edu.cs.cogcomp.lbjava.parse.ArrayFileParser;
import edu.cs.cogcomp.lbjava.parse.Parser;
import edu.cs.cogcomp.lbjava.util.ClassUtils;
import edu.cs.cogcomp.lbjava.util.FileUtils;
...
import edu.cs.cogcomp.lbjava.learn.Accuracy;
        ...
        public void run() {
            ...
            if (exFilePath != null && lce.featuresStatus != RevisionAnalysis.UNAFFECTED
                ...
                out.println("  public static Parser getParser() { return new "
                        + "edu.cs.cogcomp.lbjava.parse.ArrayFileParser(\""
