...
public class RealReferringFeature extends RealReferrer {
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        ...
        return new RealReferringFeature(containingPackage, generatingClassifier, identifier, f);
    }
    ...
    /**
     * The hash code of a <code>RealReferringFeature</code> is the sum of the hash codes of the
     * containing package, the identifier, and the referent feature.
     *
    ...
    /**
     * Two <code>RealReferringFeature</code>s are equivalent when their containing packages,
    ...
    public boolean equals(Object o) {
        return super.equals(o)
                && (o instanceof RealReferringFeature ? identifier
                        .equals(((RealReferringFeature) o).identifier) : identifier
                        .equals(((RealReferringStringFeature) o).identifier))
