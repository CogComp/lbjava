...
public class RealPrimitiveStringFeature extends RealFeature {
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        return new RealPrimitiveStringFeature(containingPackage, generatingClassifier, identifier,
                0);
    }
    ...
    public Feature encode(String e) {
        ...
        return new RealPrimitiveFeature(containingPackage, generatingClassifier, id, value);
    }


    /**
     * The hash code of a <code>RealPrimitiveStringFeature</code> is the sum of the hash codes of
     * the containing package, the identifier, and the value.
     *
    ...
    /**
     * Two <code>RealPrimitiveStringFeature</code>s are equivalent when their containing packages
