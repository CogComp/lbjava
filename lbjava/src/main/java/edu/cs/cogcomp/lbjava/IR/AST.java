...
/**
 * The root node of LBJava's AST. The parser will create only one of these and return it as the
 * ultimate result of parsing. It currently contains a single (optional)
 * <code>PackageDeclaration</code>, a <code>List</code> of <code>ImportDeclaration</code>s (also
 * optional), the global <code>SymbolTable</code>, and a <code>List</code> containing
 * <code>ClassifierAssignment</code>s, <code>ConstraintDeclaration</code>s, and
 * <code>InferenceDeclaration</code>s.
 *
 * <p>
 * The <code>PackageDeclaration</code> specifies what package will contain the generated classes.
 * The <code>ImportDeclaration</code>s work similarly to <code>import</code> declarations in regular
 * Java code: they allow the user to name classes in other packages without using their full package
 * names. The list of <code>Declaration</code>s comprises the LBJava program. The global
 * <code>SymbolTable</code> simply associates variable names with their type information in the
 * program.
 *
 * @author Nick Rizzolo
 **/
public class AST extends ASTNode {
    ...
    /**
     * (&oslash;) An optional declaration of the package that generated classes should be a part of.
     **/
    public PackageDeclaration packageDeclaration;
    /**
     * (&not;&oslash;) The list of import statements at the top of the source file.
     **/
    public ImportList imports;
    /**
     * (&not;&oslash;) The list of classifier, constraint, and inference declarations representing
     * the LBJava program.
     **/
    ...
    /**
     * Initializes just the statement list. Line and byte offset information are taken from the
     * statement list.
     *
    ...
    /**
     * Initializes both lists. Line and byte offset information are taken from the
     * <code>import</code> list.
     *
    ...
    /**
     * Initializes package declaration and statement list. Line and byte offset information are
    ...
    /**
     * Initializes all member variables. Line and byte offset information are taken from the
     ...
     **/
    public AST(PackageDeclaration p, ImportList i, DeclarationList d, int line, int byteOffset) {
    ...
    public ASTNodeIterator iterator() {
        ASTNodeIterator I = new ASTNodeIterator(packageDeclaration == null ? 2 : 3);
        if (packageDeclaration != null)
            I.children[0] = packageDeclaration;
    ...
    public Object clone() {
        ...
        return new AST(p, (ImportList) imports.clone(), (DeclarationList) declarations.clone(), -1,
                -1);
    }
