...
public abstract class DiscreteReferrer extends DiscreteFeature {
    ...
    public DiscreteReferrer(Classifier c, DiscreteFeature r, String[] av) {
        this(c.containingPackage, c.name, r, c.valueIndexOf(av[r.getValueIndex()]), (short) c
                .allowableValues().length);
    }
    ...
    public DiscreteFeature getReferent() {
        return referent;
    }
    ...
    public String getStringValue() {
        return referent.getStringValue();
    }
     ...
     * @return <code>true</code> iff <code>v</code> is equivalent to the string representation of
     *         the value of this feature.
     **/
    public boolean valueEquals(String v) {
        return referent.valueEquals(v);
    }
    ...
    /**
     * The hash code of a <code>DiscreteReferrer</code> is the sum of the hash codes of its
    ...
    public void read(ExceptionlessInputStream in) {
        super.read(in);
        referent = (DiscreteFeature) readFeature(in);
    }
