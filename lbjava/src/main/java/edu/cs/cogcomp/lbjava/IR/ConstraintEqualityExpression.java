 ...
 * The application of a learning classifier to an example object is here compared to either another
 * learning classifier application or to an arbitrary Java expression evaluating to a
 * <code>String</code>.
 *
 * @author Nick Rizzolo
 **/
public class ConstraintEqualityExpression extends ConstraintExpression {
    /**
     * (&not;&oslash;) Represents either an equality or an inequality comparison.
     **/
    public Operator operation;
    /** (&not;&oslash;) The expression on the left hand side of the operator. */
    public Expression left;
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>left</code> represents
     * the invocation of a discrete learner.
     **/
    public boolean leftIsDiscreteLearner;
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>left</code> contains
    ...
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>right</code> represents
     * the invocation of a discrete learner.
     **/
    public boolean rightIsDiscreteLearner;
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>right</code> contains
     * any quantified variables.
     **/
    ...
    /**
     * Full constructor. Line and byte offset information are taken from the operator.
     *
    ...
    public boolean containsQuantifiedVariable() {
        return left.containsQuantifiedVariable() || right.containsQuantifiedVariable();
    }
     ...
     **/
    public Object clone() {
        return new ConstraintEqualityExpression((Operator) operation.clone(),
                (Expression) left.clone(), (Expression) right.clone());
    }
