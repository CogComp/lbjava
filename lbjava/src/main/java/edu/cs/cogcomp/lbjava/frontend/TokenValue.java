...
/**
 * Objects of this class are returned by LBJava's scanner to its parser. It simply holds some
 * information about the token and provides easy access to a few primitive parsing routines.
 *
 * @author Nick Rizzolo
 **/
public class TokenValue {
     ...
     * @param byteOffset The byte offset in the file at which the token is found in the source.
     ...
     * value.
     *
     * @return The double precision floating point value that the token's text represents.
     **/
