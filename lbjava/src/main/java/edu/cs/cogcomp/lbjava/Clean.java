...
/**
 * To be run after <code>SemanticAnalysis</code>, this pass compiles the list of files created by
...
public class Clean extends Pass {
    ...
    /**
     * Adds the default files (<code>*.java</code> and <code>*.class</code>) to the remove list.
     *
     ...
     * the remove list.
     *
     * @param name The name of the classifier with which anonymous classes may be associated.
     **/
    protected void anonymousFiles(Name name) {
        ...
        if (new File(directory).exists()) {
            toAdd = new File(directory).list(new FilenameFilter() {
