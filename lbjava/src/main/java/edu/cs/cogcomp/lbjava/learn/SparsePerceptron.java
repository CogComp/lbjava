...
/**
 * Simple sparse Perceptron implementation. It is assumed that {@link Learner#labeler} is a single
 ...
 * {@link Classifier#allowableValues()} method. The second
 * value returned from {@link Classifier#allowableValues()}
 ...
 * an instance of {@link SparsePerceptron.Parameters
 ...
 * {@link SparsePerceptron.Parameters Parameters} class
...
public class SparsePerceptron extends LinearThresholdUnit {
     ...
     **/
    public SparsePerceptron(double r, double t, double pt, double nt, SparseWeightVector v) {
        super("", r, t, pt, nt, v);
    }
     ...
     **/
    public SparsePerceptron(Parameters p) {
        super(p);
    }
     ...
     **/
    public SparsePerceptron(String n) {
        super(n);
    }
     ...
     * @param v An empty sparse weight vector.
     **/
    public SparsePerceptron(String n, double r, double t, double pt, double nt, SparseWeightVector v) {
        super(n, r, t, pt, nt, v);
    }
    ...
    /**
     * Simply a container for all of {@link SparsePerceptron}'s configurable parameters. Using
