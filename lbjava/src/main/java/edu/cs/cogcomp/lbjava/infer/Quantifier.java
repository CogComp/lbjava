...
public abstract class Quantifier extends FirstOrderConstraint {
    ...
    /**
     * Makes sure that the <code>enclosingQuantificationSettings</code> vector exists, then adds a
    ...
    /**
     * The hash code of a <code>Quantifier</code> is the sum of the hash codes of its children plus
     * three.
     *
    ...
    /**
     * Two <code>Quantifier</code>s are equivalent when their children are equivalent.
     *
     * @return <code>true</code> iff the argument is an equivalent <code>Quantifier</code>.
     **/
    public boolean equals(Object o) {
        ...
        return replacer == q.replacer
                && (replacer != null || replacer == null && collection.equals(q.collection))
