...
/**
 * Used to iterate though the children of an AST node. It is assumed that the <code>children</code>
 * array never contains a <code>null</code> reference.
 *
 * @author Nick Rizzolo
 **/
public class ASTNodeIterator {
     ...
     **/
    public ASTNode next() {
        return children == null || index == children.length ? null : children[index++];
    }
