...
public class RealConjunctiveFeature extends RealFeature {
    ...
    public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
        return new RealConjunctiveFeature(containingPackage, generatingClassifier, getArgumentKey(
                left, lexicon, training, label), getArgumentKey(right, lexicon, training, label));
    }
    ...
    public Feature encode(String e) {
        ...
        if (newLeft == left && newRight == right)
            return this;
        return new RealConjunctiveFeature(containingPackage, generatingClassifier, newLeft,
                newRight);
    }
