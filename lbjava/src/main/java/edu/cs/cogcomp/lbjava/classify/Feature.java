...
import edu.cs.cogcomp.lbjava.learn.ChildLexicon;
import edu.cs.cogcomp.lbjava.learn.Lexicon;

/**
 * Objects of this class represent the value of a <code>Classifier</code>'s decision.
 *
 * @author Nick Rizzolo
 **/
public abstract class Feature implements Cloneable, Comparable, Serializable {
    /**
     * The Java <code>package</code> containing the classifier that produced this feature.
     **/
     ...
     *
     * @param p The package containing the classifier that produced this feature.
     ...
     * @return <code>true</code> iff the parameter is equivalent to the string representation of the
     *         value of this feature.
     **/
     ...
     *
     * @return <code>true</code> iff this feature contains a byte string identifier field.
     **/
     ...
     *
     * @return <code>true</code> iff this feature contains a string identifier field.
     **/
     ...
     *
     * @return A non-negative integer index, or -1 if this feature is real or doesn't have a value
     *         list.
     **/
     ...
     *         value list or a conjunctive feature whose arguments have value lists, and 0
     *         otherwise.
     **/
    ...
    /**
     * Returns a {@link RealFeature} whose value is the strength of the current feature, and whose
     * <code>identifier</code> field contains all the information necessary to distinguish this
     * feature from other features. When defining this method, <code>RealFeature</code>s may simply
     * return themselves.
     **/
    ...
    /**
     * The hash code of a <code>Feature</code> is a function of the hash codes of
     * {@link #containingPackage} and {@link #generatingClassifier}.
     *
     * @return The hash code of this <code>Feature</code>.
     **/
    public int hashCode() {
        return 31 * containingPackage.hashCode() + generatingClassifier.hashCode();
    }


    /**
     * Two <code>Feature</code>s are equal when their packages and generating classifiers are
     * equivalent.
     *
     * @return <code>true</code> iff the argument is an equivalent <code>Feature</code>.
     **/
    public boolean equals(Object o) {
        assert (getClass() == o.getClass()) == (getClass().getName().equals(o.getClass().getName())) : "getClass() doesn't behave as expected.";
        if (!(o instanceof Feature))
            return false;
        Feature f = (Feature) o;
        if (getClass() != o.getClass() && !classEquivalent(f))
            return false;

        assert !(f.containingPackage.equals(containingPackage) && f.containingPackage != containingPackage) : "Features \""
                + f + "\" and \"" + this + " have equivalent package strings in different objects.";
     ...
     * this method will return <code>true</code> iff the class of this feature and <code>f</code>
     ...
     * @return Integers appropriate for sorting features first by package, then by classifier name,
     ...
     * features. This method must be overridden in order to accomplish the comparison of
     * identifiers, but the overriding method will still have the convenience of calling this method
     * to accomplish the majority of the work.
     *
     * @param o An object to compare with.
     * @return Integers appropriate for sorting features first by package, then by classifier name,
     *         and then by identifier.
    ...
    /**
     * Writes a string representation of this <code>Feature</code>'s package, generating classifier,
     ...
     * the convenience of calling this method to accomplish most of the work first.
     *
     * @param buffer The buffer to write to.
     **/
    ...
    /**
     * Reads the binary representation of a feature of any type from the given stream. The stream is
     * expected to first return a string containing the fully qualified class name of the feature.
     * If the <i>short</i> value <code>-1</code> appears instead, this method returns
     * <code>null</code>.
     *
     * <p>
     ...
     * @param c The assumed class. If no class name is given in the input stream, a feature of this
     ...
     * @return The feature read from the stream.
     **/
    public static Feature lexReadFeature(ExceptionlessInputStream in, Lexicon lex, Class c,
            String p, String g, String si, ByteString bi) {
        String name = in.readString();
        if (name != null)
            c = ClassUtils.getClass(name);
        Feature result = null;
    ...
    public void lexRead(ExceptionlessInputStream in, Lexicon lex, String p, String g, String si,
        ...
        if (generatingClassifier == null)
            generatingClassifier = g;
        else
    ...
    /**
     * Returns a string representation of this <code>Feature</code> omitting the package.
     **/
