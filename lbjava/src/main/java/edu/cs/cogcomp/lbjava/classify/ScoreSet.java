...
public class ScoreSet implements Cloneable {
    ...
    public double get(String v) {
        return ((Score) set.get(v)).score;
    }


    /**
     * Retrieves the {@link Score} object associated with the given classification value.
     *
     * @param v The classification value.
     * @return The associated {@link Score} object.
     **/
    public Score getScore(String v) {
        return (Score) set.get(v);
    }
    ...
    /**
     * The string representation of a <code>ScoreSet</code> is the concatenation of the string
     * representations of each <code>Score</code> in the set sorted by value, separated by commas,
