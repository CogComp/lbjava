...
import edu.cs.cogcomp.lbjava.learn.IdentityNormalizer;
import edu.cs.cogcomp.lbjava.learn.Learner;
import edu.cs.cogcomp.lbjava.learn.Normalizer;


/**
 * An object of this class keeps track of all the information necessary to perform inference. Once
 * that inference has been performed, constrained classifiers access the results through this
 * class's interface to determine what their constrained predictions are.
 *
 * @author Nick Rizzolo
 **/
public abstract class Inference {
    /**
     * Produces a string representation of an example object. This method is used mainly for
     * debugging messages.
     *
     ...
     * <code>FirstOrderVariable</code> objects found in this inference's constraints. The keys are
     * also objects of type <code>FirstOrderVariable</code>, but they are not necessarily the actual
     ...
     * When implementing this method in a derived class <code>Foo</code>, it may be assumed that the
     * <code>constraint</code> member field has already been filled in appropriately, since the
     * LBJava compiler will generate a class extending <code>Foo</code> whose constructor does so.
     **/
     ...
     * Derived classes that implement an inference algorithm for use in an LBJava source file are
     * required to call this method to normalize the scores produced by classifiers before making
     * use of those scores. By default, this method returns the <code>IdentityNormalizer</code>.
     *
    ...
    /**
     * Returns the fully qualified name of the type of the head object for this inference. By
     * default, this method returns <code>"java.lang.Object"</code>. It should be overridden by
     * derived classes.
     **/
     ...
     * been defined. This method must be overridden by derived classes, since by default it returns
     * a 0-length array and every <code>Inference</code> is required to have at least one head
     * finder. <code>Inference</code> classes written by the compiler automatically override this
     ...
     *
     * @param v A variable containing the same classifier, object, and prediction value as the
     *        desired variable.
     * @return The Boolean variable corresponding to the event <i>classifier(object) ==
     *         prediction</i>.
     **/
     ...
     * Retrieves the requested variable, creating it first if it doesn't yet exist.
     *
     * @param v A variable containing the same classifier and object as the desired variable.
     * @return The variable corresponding to the application of the classifier on the object.
     **/
