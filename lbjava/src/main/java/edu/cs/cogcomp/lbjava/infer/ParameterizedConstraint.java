...
import edu.cs.cogcomp.lbjava.classify.DiscreteFeature;
...
/**
 * This class represents an LBJava constraint as it appears in a source file. When given its input
 * object, an object of this class generates objects of type <code>FirstOrderConstraint</code>.
 * <code>ParameterizedConstraint</code>s are also Boolean <code>Classifier</code>s.
 *
 * <p>
 * <code>ParameterizedConstraint</code> depends on extending classes to override the
 * <code>discreteValue(Object)</code> method so that it returns <code>"true"</code> or
 * <code>"false"</code> as appropriate. When this is done, there is no need to override the
 * <code>classify(Object)</code> method.
 *
 * @author Nick Rizzolo
 **/
public abstract class ParameterizedConstraint extends Classifier {
    ...
    public Feature featureValue(Object o) {
        ...
        return new DiscretePrimitiveStringFeature(containingPackage, name, "",
                DiscreteFeature.BooleanValues[index], index, (short) 2);
    }


    /**
     * Returns the prediction of this classifier as a <code>short</code> that acts as a pointer into
     * {@link DiscreteFeature#BooleanValues}.
     *
     * @param o The object to classify.
     ...
     * value of this method is a 0 length array.<br>
     * <br>
     *
