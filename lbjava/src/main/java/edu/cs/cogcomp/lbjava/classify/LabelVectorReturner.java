...
/**
 * This classifier expects a {@link FeatureVector} as input, and it returns the contents of its
 * {@link FeatureVector#labels labels} list in a new {@link FeatureVector} as output.
 *
 * @author Nick Rizzolo
 **/
public class LabelVectorReturner extends Classifier {
    ...
    public String getInputType() {
        return "edu.cs.cogcomp.lbjava.classify.FeatureVector";
    }
