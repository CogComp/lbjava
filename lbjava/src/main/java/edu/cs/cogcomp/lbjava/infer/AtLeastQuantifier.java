...
/**
 * An "at least" quantifier states that the constraint must hold for at least <i>m</i> of the
...
public class AtLeastQuantifier extends Quantifier {
     ...
     **/
    public AtLeastQuantifier(String q, Collection col, FirstOrderConstraint con, int m) {
    ...
    public void setQuantificationVariables(Vector o) {
        ...
        if (replacer != null) {
            ...
            if (!replacer.collectionConstant)
                collection = replacer.getCollection();
            if (!replacer.boundConstant)
                m = replacer.getBound();
        }
    }
    ...
    public PropositionalConstraint propositionalize() {
        ...
        PropositionalConstraint[] pc = new PropositionalConstraint[collection.size()];
    ...
    /**
     * The hash code of a <code>AtLeastQuantifier</code> is the sum of the hash codes of its
     * children plus one.
     *
     * @return The hash code for this <code>AtLeastQuantifier</code>.
     **/
    public int hashCode() {
        return super.hashCode() + m + 1;
    }


    /**
     * Two <code>AtLeastQuantifier</code>s are equivalent when their children are equivalent.
     *
     * @return <code>true</code> iff the argument is an equivalent <code>AtLeastQuantifier</code>.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof AtLeastQuantifier))
            return false;
