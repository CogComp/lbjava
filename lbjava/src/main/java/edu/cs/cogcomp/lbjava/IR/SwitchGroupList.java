...
public class SwitchGroupList extends List {
     ...
     *
     * @param s A single <code>SwitchGroup</code> with which to initialize this list.
     **/
     ...
     **/
    public void add(SwitchGroup s) {
        list.add(s);
    }


    /**
     * Adds all the <code>SwitchGroup</code>s in another <code>SwitchGroupList</code> to the end of
     * this <code>SwitchGroupList</code>.
     *
     * @param s The list to be added.
     **/
    public void addAll(SwitchGroupList s) {
        list.addAll(s.list);
    }
