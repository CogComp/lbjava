 ...
 * application. If the variable is <code>true</code>, then the classifier application did result in
 * the specified prediction value.
 *
 * @author Nick Rizzolo
 **/
public class PropositionalVariable extends PropositionalConstraint {
    ...
    /**
     * The prediction that the classifier must produce for this variable to be <code>true</code>.
     **/
    ...
    /**
     * Initializing constructor; the <code>value</code> member variable is set to <code>false</code>
     * .
     *
    ...
    public boolean moreSpecificThan(PropositionalImplication c) {
        ...
        return new PropositionalNegation(this).equals(children[0]) || equals(children[1]);
    }
    ...
    /**
     * The hash code of a <code>PropositionalVariable</code> is the hash code of the string
     * representation of the classifier plus the system's hash code for the example object plus the
     * hash code of the prediction.
     *
    ...
    /**
     * Two <code>PropositionalVariable</code>s are equivalent when the string representations of
     ...
     * @return <code>true</code> iff this object is equivalent to the argument object.
     **/
