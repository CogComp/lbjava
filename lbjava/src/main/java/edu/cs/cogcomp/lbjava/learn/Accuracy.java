...
import edu.cs.cogcomp.lbjava.classify.TestDiscrete;
...
public class Accuracy implements TestingMetric {
    ...
    /**
     * Creates an <code>Accuracy</code> testing metric that does not print a table of results.
     **/
    public Accuracy() {
        this(false);
    }
    ...
    /**
     * Creates an <code>Accuracy</code> testing metric that prints a table of results if requested.
     *
     ...
     * @return The fraction of examples for which the classifier's prediction was correct.
     **/
