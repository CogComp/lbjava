...
public abstract class FirstOrderEquality extends FirstOrderConstraint {
     ...
     * set to <code>null</code>, it means this <code>FirstOrderEquality</code> is not nested in a
     * quantification.
     **/
    protected EqualityArgumentReplacer replacer;
    /**
     * The map that this constraint's variables have been consolidated into, or <code>null</code> if
