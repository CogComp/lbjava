...
public class PropositionalNegation extends PropositionalConstraint {
     ...
     **/
    public PropositionalNegation(PropositionalConstraint c) {
        constraint = c;
    }
    ...
    public PropositionalConstraint CNF() {
        ...
        if (simplified instanceof PropositionalNegation)
            return simplified;
    ...
    /**
     * The hash code of a <code>PropositionalNegation</code> is the hash code of its child
     * constraint plus 1.
     *
    ...
    /**
     * Two <code>PropositionalNegation</code>s are equivalent when their constraints are equivalent.
     *
     * @return <code>true</code> iff the argument is a <code>PropositionalNegation</code> of the
     *         same constraint.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof PropositionalNegation))
            return false;
