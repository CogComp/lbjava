...
public class AtMostQuantifierExpression extends QuantifiedConstraintExpression {
    /**
     * (&not;&oslash;) This expression evaluates to an integer representing the maximum number of
    ...
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>upperBound</code>
     ...
     **/
    public AtMostQuantifierExpression(int line, int byteOffset, Expression ub, Argument a,
     ...
     * @param co The quantified constraint.
     **/
    public AtMostQuantifierExpression(TokenValue t, Expression ub, Argument a, Expression c,
     ...
     **/
    public Object clone() {
        return new AtMostQuantifierExpression(-1, -1, (Expression) upperBound.clone(),
