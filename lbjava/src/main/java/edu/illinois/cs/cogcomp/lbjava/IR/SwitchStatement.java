...
public class SwitchStatement extends Statement {
    ...
    /**
     * (&not;&oslash;) The various code blocks that are executed depending on the expression's
     * value.
     **/
     ...
     **/
    public SwitchStatement(Expression e, SwitchBlock b, int line, int byteOffset) {
     ...
     **/
    public Object clone() {
        return new SwitchStatement((Expression) expression.clone(), (SwitchBlock) block.clone(),
                -1, -1);
    }
