...
public class NormalizerType extends Type {
    ...
    public NormalizerType() {
        ...
        try {
            myClass = Class.forName("edu.illinois.cs.cogcomp.lbjava.learn.Normalizer");
        } catch (Exception e) {
            System.err
                    .println("Class 'edu.illinois.cs.cogcomp.lbjava.learn.Normalizer' not found.  "
                            + "Aborting.");
            System.exit(1);
        }
    }
    ...
    public boolean equals(Object o) {
        return o instanceof NormalizerType;
    }


    /**
     * Returns a constant, since all objects of this type are equal according to
     * {@link #equals(Object)}.
     **/
    public int hashCode() {
        return 17;
