...
public class StatementList extends List {
     ...
     *
     * @param s A single <code>Statement</code> with which to initialize this list.
     **/
    ...
    /**
     * Adds all the <code>Statement</code>s in another <code>StatementList</code> to the end of this
     * <code>StatementList</code>.
     *
     * @param s The list to be added.
     **/
    public void addAll(StatementList s) {
        list.addAll(s.list);
    }
