...
/**
 * A constraint may be invoked from within another constraint using the <code>&#64;</code> operator.
 * This class is essentially a <code>ConstraintExpression</code> wrapper for a
...
public class ConstraintInvocation extends ConstraintExpression {
    ...
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>invocation</code>
    ...
    /**
     * Parser's constructor. Line and byte offset information is taken from the token.
     *
    ...
    public HashSet getVariableTypes() {
        return invocation.getVariableTypes();
    }
     ...
     **/
    public Object clone() {
        return new ConstraintInvocation(-1, -1, (MethodInvocation) invocation.clone());
    }
