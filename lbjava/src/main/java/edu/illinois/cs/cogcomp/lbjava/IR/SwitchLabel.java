...
public class SwitchLabel extends ASTNode {
     ...
     * Full constructor.
     *
     * @param v The expression representing the value to match, if any.
     ...
     **/
    public Object clone() {
        return new SwitchLabel(value == null ? null : (Expression) value.clone(), -1, -1);
    }
