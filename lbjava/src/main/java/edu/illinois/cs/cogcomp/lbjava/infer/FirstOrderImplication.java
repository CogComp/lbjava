...
public class FirstOrderImplication extends FirstOrderBinaryConstraint {
    ...
    public PropositionalConstraint propositionalize() {
        return new PropositionalImplication(left.propositionalize(), right.propositionalize());
    }


    /**
     * The hash code of a <code>FirstOrderImplication</code> is the sum of the hash codes of its
     * children plus two.
     *
    ...
    /**
     * Two <code>FirstOrderImplication</code>s are equivalent when they are topologically
     * equivalent.
     *
    ...
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderImplication))
            return false;
