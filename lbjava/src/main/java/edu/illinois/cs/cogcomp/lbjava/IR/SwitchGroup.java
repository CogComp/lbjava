...
/**
 * Represents a list of statements labeled by one or more <code>SwitchLabel</code>s.
 *
 * @author Nick Rizzolo
 **/
public class SwitchGroup extends ASTNode {
    ...
    /**
     * Full constructor. Line and byte offset information are taken from the labels.
     *
     ...
     **/
    public Object clone() {
        return new SwitchGroup((SwitchLabelList) labels.clone(), (StatementList) statements.clone());
    }
