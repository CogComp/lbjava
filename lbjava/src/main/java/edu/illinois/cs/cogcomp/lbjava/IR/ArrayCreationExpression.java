...
public class ArrayCreationExpression extends Expression {
    /**
     * (&not;&oslash;) The most basic type of elements in the array (i.e., it will not be an
     * <code>ArrayType</code>).
     **/
     ...
     *        code represented by this node is found.
     **/
    public ArrayCreationExpression(Type t, int d, ArrayInitializer a, int line, int byteOffset) {
    ...
    public boolean equals(Object o) {
        ...
        return elementType.equals(a.elementType)
                && sizes.equals(a.sizes)
                && (initializer == null && a.initializer == null || initializer != null
                        && initializer.equals(a.initializer));
    }
     ...
     **/
    public Object clone() {
        return initializer == null ? new ArrayCreationExpression((Type) elementType.clone(),
                (ExpressionList) sizes.clone(), dimensions, -1, -1) : new ArrayCreationExpression(
                (Type) elementType.clone(), dimensions, (ArrayInitializer) initializer.clone(), -1,
                -1);
    }
