...
/**
 * All classes for representing propositional constraints are derived from this base class. A
 * propositional constraint is:
 *
 * <ul>
...
public abstract class PropositionalConstraint extends Constraint implements Cloneable {
     ...
     * objects involved. This method employs the <code>write(StringBuffer)</code> method to compute
     * its output.
     **/
