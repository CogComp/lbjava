...
public class FirstOrderDoubleImplication extends FirstOrderBinaryConstraint {
    ...
    public PropositionalConstraint propositionalize() {
        return new PropositionalDoubleImplication(left.propositionalize(), right.propositionalize());
    }


    /**
     * The hash code of a <code>FirstOrderDoubleImplication</code> is the sum of the hash codes of
    ...
    /**
     * Two <code>FirstOrderDoubleImplication</code>s are equivalent when they are topologically
    ...
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderDoubleImplication))
            return false;
