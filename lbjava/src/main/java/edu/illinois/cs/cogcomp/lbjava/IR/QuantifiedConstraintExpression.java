...
public abstract class QuantifiedConstraintExpression extends ConstraintExpression {
    /**
     * (&not;&oslash;) The variable specified by this argument is set to each of the objects from
     * the collection in turn and used throughout the quantified constraint.
     **/
    public Argument argument;
    /**
     * (&not;&oslash;) The objects to iterate through; it must evaluate to a Java
    ...
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>collection</code>
     ...
     **/
    public QuantifiedConstraintExpression(int line, int byteOffset, Argument a, Expression c,
