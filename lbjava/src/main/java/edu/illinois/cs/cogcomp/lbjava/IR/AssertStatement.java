...
public class AssertStatement extends Statement {
    /**
     * (&not;&oslash;) The condition that must hold; otherwise, an assertion error is generated.
     **/
     ...
     **/
    public Object clone() {
        return new AssertStatement((Expression) condition.clone(), (message == null ? null
                : (Expression) message.clone()), -1, -1);
    }
    ...
    public boolean equals(Object o) {
        ...
        return condition.equals(a.condition)
