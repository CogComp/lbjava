...
public class ImportList extends List {
     ...
     *
     * @param d A single <code>ImportDeclaration</code> with which to initialize this list.
     **/
     ...
     **/
    public void add(ImportDeclaration d) {
        list.add(d);
    }


    /**
     * Adds all the <code>ImportDeclaration</code>s in another <code>ImportList</code> to the end of
     * this <code>ImportList</code>.
     *
     * @param d The list to be added.
     **/
    public void addAll(ImportList d) {
        list.addAll(d.list);
    }
    ...
    public ImportDeclaration[] toArray() {
        return (ImportDeclaration[]) list.toArray(new ImportDeclaration[list.size()]);
    }
