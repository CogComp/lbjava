...
public class ExistentialQuantifier extends Quantifier {
     ...
     **/
    public ExistentialQuantifier(String q, Collection col, FirstOrderConstraint con) {
        super(q, col, con);
    }
    ...
    public PropositionalConstraint propositionalize() {
        ...
        for (Iterator I = collection.iterator(); I.hasNext();) {
            ...
            if (result == null)
                ...
                result = new PropositionalDisjunction(result, constraint.propositionalize());
        }
    ...
    /**
     * The hash code of a <code>ExistentialQuantifier</code> is the sum of the hash codes of its
     * children plus one.
     *
    ...
    /**
     * Two <code>ExistentialQuantifier</code>s are equivalent when their children are equivalent.
     *
