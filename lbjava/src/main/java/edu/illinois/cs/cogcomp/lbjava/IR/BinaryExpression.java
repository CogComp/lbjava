...
public class BinaryExpression extends Expression {
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the representation
     * of the operator.
     *
    ...
    public boolean equals(Object o) {
        ...
        return left.equals(b.left) && operation.equals(b.operation) && right.equals(b.right);
    }
     ...
     **/
    public Object clone() {
        return new BinaryExpression((Operator) operation.clone(), (Expression) left.clone(),
