...
public class SwitchLabelList extends List {
     ...
     *
     * @param s A single <code>SwitchLabel</code> with which to initialize this list.
     **/
     ...
     **/
    public void add(SwitchLabel s) {
        list.add(s);
    }


    /**
     * Adds all the <code>SwitchLabel</code>s in another <code>SwitchLabelList</code> to the end of
     * this <code>SwitchLabelList</code>.
     *
     * @param s The list to be added.
     **/
    public void addAll(SwitchLabelList s) {
        list.addAll(s.list);
    }
