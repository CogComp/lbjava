...
/**
 * Use this parser in conjunction with another parser that returns <code>LinkedVector</code>s, and
 * this parser will return their <code>LinkedChild</code>ren.
 *
 * @author Nick Rizzolo
 **/
public class ChildrenFromVectors implements Parser {
     ...
     *
     * @return The next <code>LinkedChild</code> parsed, or <code>null</code> if there are no more
