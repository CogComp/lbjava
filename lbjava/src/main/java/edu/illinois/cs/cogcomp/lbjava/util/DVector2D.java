...
/**
 * This class implements an expandable two dimensional array of doubles that should be faster than
...
public class DVector2D implements Cloneable, java.io.Serializable {
     ...
     * @throws ArrayIndexOutOfBoundsException When <code>i1</code> or <code>i2</code> &lt; 0.
     **/
    public double set(int i1, int i2, double v) {
    ...
    public double[] remove(int i) {
        ...
        int rows = sizes.size();
        if (i >= rows)
            throw new ArrayIndexOutOfBoundsException("LBJ: DVector2D: Can't remove row at index "
    ...
    public double remove(int i1, int i2) {
        ...
        if (i1 >= rows || i2 >= columns)
            throw new ArrayIndexOutOfBoundsException("LBJ: DVector2D: Can't remove index [" + i1
    ...
    /**
     * Returns a new 2D array of <code>double</code>s containing the same data as this vector.
     **/
    ...
    /**
     * Two <code>DVector2D</code>s are considered equal if they contain all the same elements,
     * sizes, and capacities.
     **/
    public boolean equals(Object o) {
        if (!(o instanceof DVector2D))
            return false;
