...
/**
 * Same as the <code>SparseWeightVector</code> class that it extends, except that this vector also
...
public class BiasedWeightVector extends SparseWeightVector {
    ...
    /**
     * Takes the dot product of this <code>BiasedWeightVector</code> with the argument vector, using
    ...
    /**
     * Outputs the contents of this <code>BiasedWeightVector</code> into the specified
     * <code>PrintStream</code>. The string representation is the same as in the super class, with
     * two added lines just after the <code>"Begin"</code> annotation that give the values of
     * {@link #bias} and {@link #initialBias}.
     *
