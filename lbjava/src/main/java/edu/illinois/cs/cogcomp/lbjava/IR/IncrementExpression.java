...
/**
 * This class represents both increment and decrement expressions. It's functionally equivalent to
 * the <code>UnaryExpression</code> class, except that it's derived from
 * <code>StatementExpression</code> instead of just <code>Expression</code>, thereby allowing it to
 * be part of an <code>ExpressionStatement</code>.
 *
 * @see UnaryExpression
...
public class IncrementExpression extends StatementExpression {
    ...
    /**
     * Initializing constructor. Line and byte offset information is taken from the increment
    ...
    public boolean equals(Object o) {
        ...
        return operation.equals(i.operation) && subexpression.equals(i.subexpression);
    }
