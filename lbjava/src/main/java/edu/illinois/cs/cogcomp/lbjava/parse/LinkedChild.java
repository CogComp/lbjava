...
/**
 * A <code>LinkedChild</code> is the child of a <code>LinkedVector</code>. <code>LinkedVector</code>
 * s use the methods of this interface to maintain links between parent and child.
 *
 * @see LinkedVector
 * @author Nick Rizzolo
 **/
public abstract class LinkedChild implements Cloneable, Serializable {
     ...
     **/
    public LinkedChild(int s, int e) {
        this(null, s, e);
    }
