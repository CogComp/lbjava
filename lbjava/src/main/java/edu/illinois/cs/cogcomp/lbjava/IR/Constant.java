...
public class Constant extends Expression {
    ...
    /**
     * Initializing constructor. The line and byte offset, having not been specified, are both set
     * to -1.
     *
    ...
    /**
     * Returns the contents of <code>value</code> removing unescaped double quotes.
     *
     * @return The contents of <code>value</code> with unescaped double quotes removed.
     **/
    ...
    /**
     * Two constants are equal when their <code>noQuotes()</code> methods return the same thing.
     *
     * @see Constant#noQuotes()
     * @return <code>true</code> iff this object is the same as the argument.
     **/
    public boolean equals(Object o) {
        return o instanceof Constant && ((Constant) o).noQuotes().equals(noQuotes());
    }
