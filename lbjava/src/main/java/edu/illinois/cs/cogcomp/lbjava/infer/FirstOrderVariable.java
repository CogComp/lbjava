...
/**
 * Represents a classifier application. An inference algorithm may change the value returned by the
 * classifier application when satisfying constraints.
 *
 * @author Nick Rizzolo
 **/
public class FirstOrderVariable implements Cloneable {
    ...
    public String getValue() {
        if (value == null) {
            if (scores == null)
                scores = classifier.scores(example);
     ...
     **/
    public void setExample(Object e) {
        example = e;
    }
    ...
    public String toString() {
        return classifier + "(" + Inference.exampleToString(example) + ") = " + value;
    }


    /**
     * The hash code of a <code>FirstOrderVariable</code> is the hash code of the string
    ...
    /**
     * Two <code>FirstOrderVariable</code>s are equivalent when their classifiers are equivalent and
    ...
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderVariable))
            return false;
