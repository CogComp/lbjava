...
/**
 * All classes for representing first order constraints are derived from this base class. A first
 * order constraint is:
 *
 * <ul>
 * <li>The constant <code>true</code> or the constant <code>false</code>.
 * <li>
 * An equality or inequality between a classifier application and a value (which may be specified
 * with an arbitrary java expression) or between two classifier applications. Operators:
 * <code>== !=</code>
 ...
 * <li>
 * A double implication between two first order constraints: <code>&lt;=&gt;</code>
 * <li>
 * An existential quantification: <code>exists <i>identifier</i> in
 *     <i>identifier</i>, <i>first-order-constraint</i></code> <br>
 * The second identifier must refer to a Java <code>Collection</code>. The first identifier is a new
 * Java variable of type <code>Object</code> that appears in the first order constraint.
 * <li>
 ...
 * The <i>expression</i> is arbitrary Java that must evaluate to a double. The two identifiers play
 * the same role as in the other quatifications. This quatification is satisfied when the number of
 * objects in the collection that satisfy <i>first-order-constraint</i> is greater than or equal to
 * <i>expression</i>.
 * <li>
 ...
 * The <i>expression</i> is arbitrary Java that must evaluate to a double. The two identifiers play
 * the same role as in the other quatifications. This quatification is satisfied when the number of
 * objects in the collection that satisfy <i>first-order-constraint</i> is less than or equal to
 * <i>expression</i>.
 * </ul>
 **/
