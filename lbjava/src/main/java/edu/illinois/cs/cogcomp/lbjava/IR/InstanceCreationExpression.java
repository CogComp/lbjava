...
public class InstanceCreationExpression extends MethodInvocation {
     ...
     *        code represented by this node is found.
     **/
    public InstanceCreationExpression(Name n, ExpressionList a, int line, int byteOffset) {
     ...
     * Initializing constructor.
     *
     * @param p Represents the parent object containing an inner class.
     * @param n The name of the class or inner class to instantiate.
     * @param line The line on which the source code represented by this node is found.
     * @param byteOffset The byte offset from the beginning of the source file at which the source
     *        code represented by this node is found.
     **/
    public InstanceCreationExpression(Expression p, Name n, int line, int byteOffset) {
     ...
     *        code represented by this node is found.
     **/
    public InstanceCreationExpression(Expression p, Name n, ExpressionList a, int line,
            int byteOffset) {
     ...
     **/
    public Object clone() {
        return new InstanceCreationExpression((parentObject == null) ? null
