...
public class SwitchBlock extends ASTNode {
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the labels.
     *
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the groups.
     *
     * @param g The list of groups.
     **/
    public SwitchBlock(SwitchGroupList g) {
        this(g, new SwitchLabelList());
    }
     ...
     *        code represented by this node is found.
     **/
    public SwitchBlock(SwitchGroupList g, SwitchLabelList l, int line, int byteOffset) {
