...
class ScannerError {
    /**
     * Signal an error due to an unterminated comment appearing in the token stream.
     **/
    ...
    /**
     * Signal an error due to discovering an end-of-comment marker while not scanning a comment.
     **/
    ...
    /**
     * Signal an error due to an invalid character (one which is not specified as being allowed by
     * the language definition) in the source text.
     **/
    ...
    /**
     * Signal an error in scanning which does not fall into any of the above categories.
     **/
