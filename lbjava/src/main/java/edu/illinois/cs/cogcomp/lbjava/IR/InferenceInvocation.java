...
public class InferenceInvocation extends ClassifierExpression {
    ...
    /**
     * Initializing constructor. Line and byte offset information are taken from the name of the
     * inference.
     *
    ...
    public boolean equals(Object o) {
        if (!(o instanceof InferenceInvocation))
            return false;
     ...
     **/
    public Object clone() {
        return new InferenceInvocation((Name) inference.clone(), (Name) classifier.clone());
    }
