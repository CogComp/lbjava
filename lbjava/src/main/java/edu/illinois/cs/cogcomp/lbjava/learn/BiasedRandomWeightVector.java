...
public class BiasedRandomWeightVector extends RandomWeightVector {
    ...
    /**
     * Takes the dot product of this <code>BiasedRandomWeightVector</code> with the argument vector,
    ...
    /**
     * Outputs a textual representation of this vector to the specified stream. The string
     * representation is the same as in {@link SparseWeightVector#write(PrintStream)}, with two
     * added lines just after the <code>"Begin"</code> annotation that give the values of
