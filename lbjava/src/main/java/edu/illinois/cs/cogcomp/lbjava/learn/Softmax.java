 ...
 * of the sum of all scores' exponentials. In other words, each score <code>s<sub>i</sub></code> is
 * replaced by <code>exp(alpha s<sub>i</sub>) / sum<sub>j</sub> exp(alpha
 * s<sub>j</sub>)</code>, where <code>alpha</code> is a user-specified constant.
 *
 * @author Nick Rizzolo
 **/
