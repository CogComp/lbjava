 ...
 * many times as the integer the first <code><i>expression</i></code> evaluates to.
 *
 * @author Nick Rizzolo
 **/
public class AtLeastQuantifierExpression extends QuantifiedConstraintExpression {
    /**
     * (&not;&oslash;) This expression evaluates to an integer representing the minimum number of
    ...
    /**
     * Filled in by <code>SemanticAnalysis</code>, this flag is set if <code>lowerBound</code>
     ...
     **/
    public AtLeastQuantifierExpression(int line, int byteOffset, Expression lb, Argument a,
     ...
     * @param co The quantified constraint.
     **/
    public AtLeastQuantifierExpression(TokenValue t, Expression lb, Argument a, Expression c,
     ...
     **/
    public Object clone() {
        return new AtLeastQuantifierExpression(-1, -1, (Expression) lowerBound.clone(),
                (Argument) argument.clone(), (Expression) collection.clone(),
