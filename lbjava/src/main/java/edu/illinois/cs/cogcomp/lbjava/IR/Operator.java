...
/**
 * LBJava supports every Java operator. This class stores information about those operators, such as
 * their symbols and precedences, as well as information about LBJava's new operators. The static
 * constant fields defined in this class serve as indeces into its static array fields.
 *
 * <p>
 * The precedence values for Java operators were taken from <a target=_top
 * href="http://www.java-faq.com/java-operator-precedence.shtml">Java-FAQ.com</a>.
 * 
 * @author Nick Rizzolo
 **/
public class Operator extends ASTNode {
    ...
    /**
     * This array contains the text representations of every symbol that objects of this class can
     * represent. <code>
     * {
     *   ".", "++", "++", "--", "--", "~", "!", "new", "*", "/", "%", "+", "-",
     *   "&lt;&lt;", "&gt;&gt;", "&gt;&gt;&gt;", "&lt;", "&lt;=", "&gt;",
     ...
     * }</code>
     **/
    private static final String[] symbols = {".", "++", "++", "--", "--", "~", "!", "new", "*",
            "/", "%", "+", "-", "<<", ">>", ">>>", "<", "<=", ">", ">=", "instanceof", "==", "!=",
            "&", "^", "|", "&&", "||", "?", "=", "*=", "/=", "%=", "+=", "-=", "<<=", ">>=",
            ">>>=", "&=", "|=", "^=", "&&", "<-", "::", "!:", "/\\", "\\/", "=>", "<=>"};

    /**
     * This array contains the precedences of every operator in the same order that they appear in
     * the <code>symbols</code> array. <code>=
     * {
     ...
     **/
    private static final int[] precedences = {1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 4, 4, 5, 5, 5, 6, 6,
            6, 6, 6, 7, 7, 8, 9, 10, 11, 12, 13, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14,
            15, 16, 1, 1, 2, 3, 4, 5};

    /**
     * Produces the name of an operator given its index.
     *
     * @param operation The index of the operation. (See the static member variables.)
    ...
    /**
     * Default constructor. Line and byte offset information, having not been specified, is set to
     * -1.
     *
     * @param operation The index of the operation.
     **/
