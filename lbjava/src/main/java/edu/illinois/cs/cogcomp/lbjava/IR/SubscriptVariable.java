...
public class SubscriptVariable extends VariableInstance {
    ...
    /**
     * (&not;&oslash;) The expression whose evaluation will be used as the subscript.
     **/
    public Expression subscript;


    /**
     * Initializing constructor. Line and byte offset information is taken from the first
     * expression.
     *
     ...
     **/
    public int hashCode() {
        return array.hashCode() + subscript.hashCode();
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof SubscriptVariable))
            return false;
     ...
     **/
    public Object clone() {
        return new SubscriptVariable((Expression) array.clone(), (Expression) subscript.clone());
    }
