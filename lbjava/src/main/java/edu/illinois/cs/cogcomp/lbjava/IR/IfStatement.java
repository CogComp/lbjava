...
public class IfStatement extends Statement {
    /**
     * (&not;&oslash;) The condition controlling execution of the sub-statements.
     **/
     ...
     * @param c The condition controlling execution.
     * @param t The statement to execute if the condition is true.
     * @param e The statement to execute if the condition is false, if any.
     * @param line The line on which the source code represented by this node is found.
     * @param byteOffset The byte offset from the beginning of the source file at which the source
     *        code represented by this node is found.
     **/
    public IfStatement(Expression c, Statement t, Statement e, int line, int byteOffset) {
     ...
     **/
    public Object clone() {
        return new IfStatement((Expression) condition.clone(), (Statement) thenClause.clone(),
    ...
    public boolean equals(Object o) {
        ...
        return condition.equals(i.condition) && thenClause.equals(i.thenClause)
                && (elseClause == null ? i.elseClause == null : elseClause.equals(i.elseClause));
    }
