...
public class FirstOrderConjunction extends FirstOrderNAryConstraint {
    /**
     * If either of the arguments is itself a <code>FirstOrderConjunction</code>, its contents are
     * flattened into this <code>FirstOrderConjunction</code>.
     *
    ...
    public PropositionalConstraint propositionalize() {
        ...
        PropositionalConjunction result =
                new PropositionalConjunction(c[0].propositionalize(), c[1].propositionalize());
    ...
    /**
     * The hash code of a <code>FirstOrderConjunction</code> is the sum of the hash codes of its
     * children plus one.
     *
    ...
    /**
     * Two <code>FirstOrderConjunction</code>s are equivalent when they are topologically
    ...
    public boolean equals(Object o) {
        if (!(o instanceof FirstOrderConjunction))
            return false;
