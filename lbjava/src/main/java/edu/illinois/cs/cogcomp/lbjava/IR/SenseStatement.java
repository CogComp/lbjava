...
public class SenseStatement extends Statement {
    /**
     * (&oslash;) Represents the name of the feature being sensed (only used in generators).
     **/
     ...
     *
     * @param v The value of the feature being sensed.
     * @param all <code>true</code> iff this is a <code>senseall</code> statement.
     * @param line The line on which the source code represented by this node is found.
     * @param byteOffset The byte offset from the beginning of the source file at which the source
     *        code represented by this node is found.
     **/
     ...
     *        code represented by this node is found.
     **/
    public SenseStatement(Expression n, Expression v, boolean all, int line, int byteOffset) {
     ...
     **/
    public Object clone() {
        return new SenseStatement((name == null ? null : (Expression) name.clone()),
    ...
    public boolean equals(Object o) {
        if (!(o instanceof SenseStatement))
            return false;
        SenseStatement s = (SenseStatement) o;
        return senseall == s.senseall && value.equals(s.value)
